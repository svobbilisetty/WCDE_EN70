...
<html lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
		...
		<title><fmt:message key="UnsupportedBrowserError_Title"/></title>
				...
				<div class="ie6_Container">
					<div class="ie6_BrowserError">
						<div class="ie6_Content">
							...
							<div class="ie6_Header" role="heading" aria-level="1"><fmt:message key="UnsupportedBrowserError_Title" /></div>
							<div class="ie6_Message"><fmt:message key="UnsupportedBrowserError_Text" /></div>
