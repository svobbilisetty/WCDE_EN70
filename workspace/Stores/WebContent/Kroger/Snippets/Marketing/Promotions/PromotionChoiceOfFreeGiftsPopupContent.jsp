					...
					<c:choose>
						<c:when test="${promotionStatus == 'active'}">
							...
							<div class="header" id="popupHeader">
								...
								<a role="button" id="promotionChoice_closeLink" class="close tlignore" title="<fmt:message key='PROMOTION_FREE_GIFTS_POPUP_CLOSE'/>" href="javascript: PromotionChoiceOfFreeGiftsJS.hideFreeGiftsPopup('free_gifts_popup');"></a>
								<div class="clear_float"></div>
							</div>
							<div class="body">              
												...
												<div class="gift_item_container" id="WC_PromotionChoiceOfFreeGiftsPopupContent_div_5_${status.count}_${status2.count}">
													...
													<div class="product_info" id="WC_PromotionChoiceOfFreeGiftsPopupContent_div_8_${status.count}_${status2.count}">        
														...
														<c:if test="${showInventory}">
															...
															<fmt:message key="IMG_NAME_${invStatus}" var="imageName"/>
