	...
	<div class="my_account" id="WC_OrderShipmentDetails_div_1">
	    ...
	    <div class="body" id="WC_OrderShipmentDetails_div_6">
			...
			<p>
				...
				<span id="OrderNo"><fmt:message key="MO_NOT_AVAILABLE" /></span>
					
			</p>
			<p>
				<span class="my_account_content_bold"><fmt:message key="MO_ORDER_DATE" /></span>				
				<span id="OrderDate"><fmt:message key="MO_NOT_AVAILABLE" /></span>
	        ...
	        <div class="myaccount_header" id="WC_OrderShipmentDetails_div_8">
		        ...
		        <div class="left" id="WC_OrderShipmentDetails_div_10"><span class="header"><fmt:message key="MO_SHIPPINGINFO" /></span></div>
	        ...
	        <div class="myaccount_content margin_below" id="WC_OrderShipmentDetails_div_16">
			    ...
			    <c:choose>
					...
					<div class="shipping_method" id="WC_OrderShipmentDetails_div_18">
							...
							<flow:ifEnabled feature="ShipAsComplete">
								<span class="my_account_content_bold"><fmt:message key="SHIP_SHIP_AS_COMPLETE" />: </span>						
										...
										<span class="text" id="Shipping_As_Complete_Y"><fmt:message key="YES" /></span>
									
										<span class="text" style=display:none id="Shipping_As_Complete_N"><fmt:message key="NO" /></span>
					...
					<table id="order_total" cellpadding="0" cellspacing="0" border="0" summary="<fmt:message key="ORDER_TOTAL_TABLE_SUMMARY" />">
					...
					<tr> 
						...
						<td class="total_figures" id="WC_SingleShipmentOrderTotalsSummary_td_2">
									...
									<span id="Order_SubTotal"><fmt:message key="MO_NOT_AVAILABLE" /></span>
					...
					<tr>
						...
						<td class="total_figures" id="WC_SingleShipmentOrderTotalsSummary_td_12">
									...
									<span id="Order_Discount"><fmt:message key="MO_NOT_AVAILABLE" /></span>
					...
					<tr> 
						...
						<td class="total_figures" id="WC_SingleShipmentOrderTotalsSummary_td_6">
									...
									<span id="Order_Tax"><fmt:message key="MO_NOT_AVAILABLE" /></span>
					...
					<tr>
						...
						<td class="total_figures" id="WC_SingleShipmentOrderTotalsSummary_td_8">
									...
									<span id="Order_Shipping"><fmt:message key="MO_NOT_AVAILABLE" /></span>
					...
					<tr>
						...
						<td class="total_figures" id="WC_SingleShipmentOrderTotalsSummary_td_15">
									...
									<span id="Order_ShippingTax"><fmt:message key="MO_NOT_AVAILABLE" /></span>
					...
					<tr>
						...
						<td class="total_figures breadcrumb_current" id="WC_SingleShipmentOrderTotalsSummary_td_10">
									...
									<span id="Order_Totals"><fmt:message key="MO_NOT_AVAILABLE" /></span>					
		...
		<div class="gift_section">
		    <div class="myaccount_section_header" id="WC_OrderShipmentDetails_div_21">
		        ...
		        <div class="left" id="WC_OrderShipmentDetails_div_23"><span class="header"><fmt:message key="MO_BILLINGINFO" /></span></div>
					...
					<div class="billing_summary" >
						<c:if test="${numberOfPaymentMethods > 1}">
							<div <c:if test="${paymentCount >= 1}">class="billing_border"</c:if> id="WC_CheckoutPaymentAndBillingAddressSummaryf_div_1_<c:out value='${paymentCount}'/>">
								<c:if test="${paymentCount >= 1}"> <br /> </c:if> 
									<p class="title"><fmt:message key="PAYMENT_CAPS" /><span><c:out value='${paymentCount+1}'/></span></p>
							</div>
							<br />
						 </c:if>						 
						...
						<div class="billing_method" id="WC_CheckoutPaymentAndBillingAddressSummaryf_div_3_<c:out value='${paymentCount}'/>">
							...
							<p class="title"><fmt:message key="BILL_BILLING_METHOD" /></p>																													
										<span id="Payment_Method_Name_<c:out value='${paymentCount}'/>"><fmt:message key="MO_NOT_AVAILABLE" /></span>
									
							<p>	
							<br/>
								<div id="Div_CreditCard_<c:out value='${paymentCount}'/>" style=display:none>
									<p><span id="WC_PaymentType_CreditCard_<c:out value='${paymentCount}'/>"><fmt:message key="account" /></span></p>
									<p><span id="CreditCard_Account_<c:out value='${paymentCount}'/>"></span></p>
									
									<p><span><fmt:message key="expire_month" /></span></p>
									<p><span id="CreditCard_Expiration_Month_<c:out value='${paymentCount}'/>"></span></p>
									<p><span><fmt:message key="expire_year" /></span></p>
								...
								<div id="Div_Check_<c:out value='${paymentCount}'/>" style=display:none>
									<p><span id="WC_PaymentType_Check_<c:out value='${paymentCount}'/>"><fmt:message key="account" /></span></p>
								...
								<div id="Div_LineOfCredit_<c:out value='${paymentCount}'/>" style=display:none>					
									<p><span id="WC_PaymentType_LineOfCredit_<c:out value='${paymentCount}'/>"><fmt:message key="account" /></span></p>
							...
							<p class="price">
									...
									<span id="Payment_Method_Amount_<c:out value='${paymentCount}'/>"><fmt:message key="MO_NOT_AVAILABLE" /></span>
