...
<%--
  ...
  *****
--%>
<!-- BEGIN UnregisteredCheckoutAddressEntryForm_JP_KR.jsp-->
...
<div class="label_spacer" id="WC_${formName}_firstName_div_9">
	...
	<span class="required-field" id="WC_${formName}_firstName_div_10"> *</span>
	<fmt:message key="FIRST_NAME"/></div>
<div id="WC_${formName}_firstName_div_11">
	<input type="text" aria-required="true" name="firstName" id="<c:out value='WC_${pageName}_ShoppingCartAddressEntryForm_${formName}_${paramPrefix}firstName_1'/>" size="35" class="form_input" value="<c:out value='${contact.contactName.firstName}'/>" />
</div>


<%-- country/region --%>
<div class="label_spacer" id="WC_${formName}_country_div_12">
	<span class="spanacce">
...
<%-- zipcode --%>
<div class="label_spacer" id="WC_${formName}_zipCode_div_15">
	<span class="spanacce">
	...
	<span class="required-field" id="WC_${formName}_zipCode_div_16"> *</span>
	<fmt:message key="ZIP_CODE"/></div>
<div id="WC_${formName}_zipCode_div_17">
...
<%-- state/province --%>
<div class="label_spacer" id="WC_${formName}_state_div_18">
	<span class="spanacce">
	...
	<span class="required-field" id="WC_${formName}_state_div_19"> *</span>
...
<%-- city --%>
<div class="label_spacer" id="WC_${formName}_city_div_20">
	<span class="spanacce">
	...
	<span class="required-field" id="WC_${formName}_city_div_21"> *</span>
	<fmt:message key="CITY2"/></div>
<div id="WC_${formName}_city_div_22">
...
<%-- address --%>
<div class="label_spacer" id="WC_${formName}_address1_div_23">
	<span class="spanacce">
	...
	<span class="required-field" id="WC_${formName}_address1_div_24"> *</span>
	<fmt:message key="STREET_ADDRESS"/></div>
<div id="WC_${formName}_address1_div_25">
...
<%-- phone --%>
<div class="label_spacer" id="WC_${formName}_phone1_div_26">
<span class="spanacce">
...
<div id="WC_${formName}_phone1_div_27">
...
<%-- email --%>
<div class="label_spacer" id="WC_${formName}_email1_div_28">
	<span class="spanacce">
	...
	<span class="required-field" id="WC_${formName}_email1_div_29"> *</span>
	<fmt:message key="EMAIL"/></div>
<div id="WC_${formName}_email1_div_30">
...
<!-- END UnregisteredCheckoutAddressEntryForm_JP_KR.jsp-->
