...
<%--
  ...
  *****
--%>
<!-- BEGIN UnregisteredCheckoutAddressEntryForm_RU.jsp-->
...
<%-- middle name --%>
<div class="label_spacer" id="WC_${formName}_middleName_div_30">
	<span class="spanacce">
	<label for="<c:out value='WC_${pageName}_ShoppingCartAddressEntryForm_${formName}_${paramPrefix}middleName_1'/>">
	<fmt:message key="SHIPPING_AND_BILLING_ADDRESS_LABEL_TEXT2">
	<fmt:param><fmt:message key="MIDDLE_NAME"/></fmt:param>
	<fmt:param>${address}</fmt:param></fmt:message>
	</label>
	</span>
	<fmt:message key="MIDDLE_NAME"/></div>
<div id="WC_${formName}_middleName_div_31">
	<input type="text" name="middleName" id="<c:out value='WC_${pageName}_ShoppingCartAddressEntryForm_${formName}_${paramPrefix}middleName_1'/>" size="35" class="form_input" value="<c:out value='${contact.contactName.middleName}'/>" />
</div>
...
<!-- END UnregisteredCheckoutAddressEntryForm_RU.jsp-->
