...
<div class="card_info" id="WC_StandardBankServACH_div_1_<c:out value='${paymentAreaNumber}'/>">
	...
	<span class="col1">
		<span>
			<span class="required-field">*</span><label for="BankServACH_FormInput_checkingAccountNumber_1_<c:out value='${paymentAreaNumber}' />"><span><fmt:message key="EDPPaymentMethods_BANK_ACCOUNT_NO" /></span></label>
		</span>
		<span>
		...
		<span>
			<span class="required-field">*</span><label for="BankServACH_FormInput_checkRoutingNumber_1_<c:out value='${paymentAreaNumber}' />"><span><fmt:message key="EDPPaymentMethods_BANK_ROUTING_NO" /></span></label>
		</span>
		<span>
