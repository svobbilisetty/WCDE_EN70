	...
	<span class="col1">
		...
		<span class="visaCVV2">
			<span id="CVVDetailsSection_<c:out value='${paymentAreaNumber}'/>">		
				...
				<script type="text/javascript">dojo.addOnLoad(function() {parseWidget("StandardVisa_CVVDetails_<c:out value='${paymentAreaNumber}'/>_span_2"); });</script>
			</span>
		</span>
		<span class="date">
