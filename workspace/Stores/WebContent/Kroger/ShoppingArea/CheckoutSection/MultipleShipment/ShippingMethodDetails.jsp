...
<div class="shipping_method_MS_shipping_info_page" id="WC_ShippingMethodDetails_div_<c:out value='${orderItemId}'/>">
	<p>
		<label for="MS_ShippingMode_<c:out value='${orderItemId}'/>"><span class="spanacce"><fmt:message key="SHIP_SHIPPING_METHOD"/></span></label>
	...
	<c:if test="${!isFreeGift}">
		<flow:ifEnabled feature="ShippingInstructions">
			...
			<p>
				<span class="checkbox">
					...
					/>
					<label for="MS_shippingInstructionsCheckbox_<c:out value='${orderItemId}'/>"><span class="text"><fmt:message key="SHIP_SHIPPING_INSTRUCTIONS_ADD" /></span></label>
				</span>
			</p>
		...
		<c:if test="${showFutureOrders}">
			...
			<p>
				<span class="checkbox">
					...
					/>
					<label for="MS_requestShippingDateCheckbox_<c:out value='${orderItemId}'/>"><span class="text"><fmt:message key="SHIP_REQUESTED_DATE_ADD" /></span></label>
				</span>
			</p>
		...
		<flow:ifEnabled feature="ExpeditedOrders">
			<span class="checkbox">
				...
				<span class="text">
					<label for="MS_expediteShipping_<c:out value='${orderItemId}'/>"><fmt:message key="SHIP_EXPEDITE_SHIPPING" /></label>
				</span>
			</span>
		</flow:ifEnabled>
