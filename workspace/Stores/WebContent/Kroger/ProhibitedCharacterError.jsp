...
<html lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
		<title><fmt:message key="PROHIBITEDCHAR_ERROR_TITLE"/></title>
							...
							<div class="main_content">
								<div class="container_full_width">
									<div id="box" class="my_account generic_error_container">
										<div id="errorPage">
											<h1 class="myaccount_header"><fmt:message key="PROHIBITEDCHAR_ERROR_TITLE" /></h1>
												...
												<div id="WC_PCE_6" class="info">						
													...
													<c:choose>
														<c:when test="${WCParam.ErrorCode == 'WildcardSearchError'}">
															<fmt:message key="PROHIBITEDCHAR_ERROR_WILDCARD_DESC" />
														</c:when>
														<c:otherwise>
															<fmt:message key="PROHIBITEDCHAR_ERROR_DESC" />
														</c:otherwise>
													</c:choose>
													<br /><br />
													<fmt:message key="PROHIBITEDCHAR_ERROR_BACK_DESC" />
													<br /><br />
													<a href="#" class="button_primary" id="WC_ProhibitedCharacterError_Link_1" tabindex="0" onclick="javascript:history.back(1)">
														<div class="left_border"></div>
														<div class="button_text"><fmt:message key="PROHIBITEDCHAR_ERROR_BACK"/></div>
