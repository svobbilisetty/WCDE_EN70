											...
											<div class="widget_title_container categorySpot">
												<c:if test="${env_inPreview && !env_storePreviewLink}">
													...
													<div class="ESpotInfo">
														...
														<a id="SubCategoryPage_click2edit_Category_${WCParam.categoryId}" class="click2edit_button"  href="javascript:void(0)" onclick="parent.callManagementCenter('<wcf:out escapeFormat="js" value="${clickToEditURL}"/>');" ><fmt:message bundle='${previewText}' key='Click2Edit_category'/></a>
													</div>
												</c:if>
