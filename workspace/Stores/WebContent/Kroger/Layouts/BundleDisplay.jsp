					...
					<div class="content_left_shadow">
						<div class="content_right_shadow">				
							<div class="main_content">
								...
								<div class="container_product_details_bundle_package container_margin_5px productDetail">
								<c:if test="${env_inPreview && !env_storePreviewLink}">
									...
									<div class="ESpotInfo">
										...
										<a id="BundleDisplay_click2edit_Product_${productId}" class="click2edit_button"  href="javascript:void(0)" onclick="parent.callManagementCenter('<wcf:out escapeFormat="js" value="${clickToEditURL}"/>');" ><fmt:message bundle='${previewText}' key='Click2Edit_product'/></a>
									</div>
								</c:if>
								...
								<div class="container_full_width_bundle">
									<fmt:message key='BD_CONFIGURE_ITEMS_IN_BUNDLE'/>
								</div>
								...
								<div class="container_content_rightsidebar container_margin">
									...
									<div class="right_column">
										...
										<% out.flush(); %>
											<c:import url = "${env_jspStoreDir}Widgets/BundleSummary/BundleSummary.jsp"/>
										<% out.flush(); %>
										</div>
