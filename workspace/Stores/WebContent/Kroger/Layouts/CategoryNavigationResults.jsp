...
<div><%@ include file="../Widgets/ESpot/include/ESpotInfoPopupDisplay.jspf"%></div>
				...
				<div class="right_border">
					<div class="content">
						<div class="header_bar">
							<div class="title"><fmt:message key="PAGINATION_PRODUCTS"/> 
							...
							<div id="compare_button" class="compare_controls disabled">
								...
								<a id="compare_button_enabled" href="Javascript:setCurrentId('compare_button_enabled');shoppingActionsJS.compareProducts(<c:out value='${categoryIds}'/>);" class="button_primary" wairole="button" role="button" style="display:none;">
									<div class="left_border"></div>
									<div class="button_text"><fmt:message key="COMPARE_SELECTED"/></div>
									<div class="right_border"></div>
								</a>
	...
	<script>
		function updateFacetCounts() {
			...
			if(searchTotalCount != null) {
				<c:if test="${empty originalTotalSearchCount}">
					<c:set var="originalTotalSearchCount" value="0"/>
				</c:if>
				var productCount = <c:out value="${originalTotalSearchCount}"/>;
				var totalCount = productCount + _originalTotalContentCount;
				var message = '<fmt:message key = "{0}_matches"><fmt:param value="%1"/></fmt:message>';
				searchTotalCount.innerHTML = message.replace("%1", totalCount);
			}
