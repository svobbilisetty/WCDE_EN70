							...
							<div class="main_content">
								...
								<c:if test="${env_inPreview && !env_storePreviewLink}">
									...
									<div class="ESpotInfo">
										...
										<a id="DynamicKitDisplay_click2edit_Product_${productId}" class="click2edit_button"  href="javascript:void(0)" onclick="parent.callManagementCenter('<wcf:out escapeFormat="js" value="${clickToEditURL}"/>');" ><fmt:message bundle='${previewText}' key='Click2Edit_product'/></a>
									</div>
								</c:if>
