...
<html lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
		<title><fmt:message key="CSRF_ERROR_TITLE"/></title>
							...
							<div class="main_content">
								<div class="container_full_width">
									<div id="box" class=" my_account generic_error_container">
										<div id="errorPage">
											<h1 class="myaccount_header"><fmt:message key="CSRF_ERROR_TITLE" /></h1>
										</div>
										<div id="WC_CSRFErrorDisplay_4" class="content">
											<div id="WC_CSRFErrorDisplay_5" class="info">
												<fmt:message key="CSRF_ERROR_DESC" />
												<br /><br />
												<fmt:message key="PROHIBITEDCHAR_ERROR_BACK_DESC" />
												<br /><br />
												<a href="#" class="button_primary" id="WC_CSRFError_Link_1" tabindex="0" onclick="javascript:history.back(1)">
