	 	...
	 	<div id="breadcrumb">
			...
			<c:choose>
					...
					<div id="orderItemDisplay">
						<c:choose>
							<c:when test="${displayCheckoutNavBarOnShoppingCartPage}">
								<span id="step1" class="step_on" title="<fmt:message key='BCT_SHOPPING_CART'/>"><fmt:message key='BCT_SHOPPING_CART'/></span>
								<span class="step_arrow"></span>
								<span id="step2" class="step_off" title="<fmt:message key='BCT_ADDRESS'/>"><fmt:message key='BCT_ADDRESS'/></span>
								<span class="step_arrow"></span>
								<span id="step3" class="step_off" title="<fmt:message key='BCT_SHIPPING_AND_BILLING'/>"><fmt:message key='BCT_SHIPPING_AND_BILLING'/></span>
								<span class="step_arrow"></span>
								<span id="step4" class="step_off" title="<fmt:message key='BCT_ORDER_SUMMARY'/>"><fmt:message key='BCT_ORDER_SUMMARY'/></span>
							</c:when>
							<c:otherwise>
								<div class="headingtext"><span aria-level="1" class="on" role="heading"><fmt:message key="SHOPPINGCART_TITLE"/></span></div>
				...
				<c:when test="${pendingOrderDetailsPage}">
					<div id="orderItemDisplay">
							<%-- Missing message --%>
							<div class="left"><span class="on"><fmt:message key="PENDING_ORDER_HEADER_TITLE"/></span></div>
					</div>
					<br clear="all"/>
				</c:when>
				<c:otherwise>
		...
		<div id="breadcrumb">
			<div class="title" id="WC_MyAccountDisplay_div_1">
				<h1 class="myaccount_title">
					<a id="MyAccountBreadcrumbLink" class="landingpage_link" href="${MyAccountURL}"> <fmt:message key="MA_MYACCOUNT"/></a>
					<span id="OrderHistoryBreadcrumb1" class="myaccount_breadcrumb" style="display:none;">
						<a id="OrderHistoryMyAccountBreadcrumbLink1" class="landingpage_link" href="${MyAccountURL}"> <fmt:message key="MA_MYACCOUNT"/></a>
						<span class="divider"><fmt:message key="DIVIDING_BAR"/></span>
						<a id="OrderHistoryBreadcrumbLink1" class="current_breadcrumb" href="#"><fmt:message key="MA_ORDER_HISTORY"/></a>
					</span>
					<span id="OrderHistoryBreadcrumb" class="myaccount_breadcrumb" style="display:none;">
						<a id="OrderHistoryMyAccountBreadcrumbLink" class="landingpage_link" href="${MyAccountURL}"> <fmt:message key="MA_MYACCOUNT"/></a>
						<span class="divider"><fmt:message key="DIVIDING_BAR"/></span>
						<a id="OrderHistoryBreadcrumbLink" class="sub_breadcrumb" href="<c:out value='${trackOrderStatusURL}'/>"><fmt:message key="MA_ORDER_HISTORY"/></a>
						<span class="divider"><fmt:message key="DIVIDING_BAR"/></span>
					...
					<flow:ifEnabled feature="RecurringOrders">
						<span id="RecurringOrderBreadcrumb1" class="myaccount_breadcrumb" style="display:none;">
							<a id="RecurringOrderMyAccountBreadcrumbLink1" class="landingpage_link" href="${MyAccountURL}"> <fmt:message key="MA_MYACCOUNT"/></a>
							<span class="divider"><fmt:message key="DIVIDING_BAR"/></span>
							<a id="RecurringOrderBreadcrumbLink1" class="current_breadcrumb" href="#"><fmt:message key="MA_SCHEDULEDORDERS"/></a>
						</span>
						<span id="RecurringOrderBreadcrumb" class="myaccount_breadcrumb" style="display:none;">
							<a id="RecurringOrderMyAccountBreadcrumbLink" class="landingpage_link" href="${MyAccountURL}"> <fmt:message key="MA_MYACCOUNT"/></a>
							<span class="divider"><fmt:message key="DIVIDING_BAR"/></span>
							<a id="RecurringOrderBreadcrumbLink" class="sub_breadcrumb" href="<c:out value='${trackRecurringOrderStatusURL}'/>"><fmt:message key="MA_SCHEDULEDORDERS"/></a>
							<span class="divider"><fmt:message key="DIVIDING_BAR"/></span>
					...
					<flow:ifEnabled feature="Subscription">
						<span id="SubscriptionBreadcrumb1" class="myaccount_breadcrumb" style="display:none;">
							<a id="SubscriptionMyAccountBreadcrumbLink1" class="landingpage_link" href="${MyAccountURL}"> <fmt:message key="MA_MYACCOUNT"/></a>
							<span class="divider"><fmt:message key="DIVIDING_BAR"/></span>
							<a id="SubscriptionBreadcrumbLink1" class="current_breadcrumb" href="#"><fmt:message key="MA_SUBSCRIPTIONS"/></a>
						</span>
						<span id="SubscriptionBreadcrumb" class="myaccount_breadcrumb" style="display:none;">
							<a id="SubscriptionMyAccountBreadcrumbLink" class="landingpage_link" href="${MyAccountURL}"> <fmt:message key="MA_MYACCOUNT"/></a>
							<span class="divider"><fmt:message key="DIVIDING_BAR"/></span>
							<a id="SubscriptionBreadcrumbLink" class="sub_breadcrumb" href="<c:out value='${trackSubscriptionStatusURL}'/>"><fmt:message key="MA_SUBSCRIPTIONS"/></a>
							<span class="divider"><fmt:message key="DIVIDING_BAR"/></span>
