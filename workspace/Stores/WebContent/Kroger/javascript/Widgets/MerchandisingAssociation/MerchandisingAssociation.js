		...
		**/
		changeItem: function(direction){
			if((this.associationIndex + direction) >= 0 && (this.associationIndex + direction) < this.merchandisingAssociations.length) {
				...
				if(document.getElementById("ProductInfoName_"+this.merchandisingAssociations[this.associationIndex-direction].id) != null){
					document.getElementById("ProductInfoName_"+this.merchandisingAssociations[this.associationIndex-direction].id).value = this.merchandisingAssociations[this.associationIndex].name;
					document.getElementById("ProductInfoName_"+this.merchandisingAssociations[this.associationIndex-direction].id).id = "ProductInfoName_" + this.merchandisingAssociations[this.associationIndex].id;
				}
				...
				if(document.getElementById("ProductInfoImage_"+this.merchandisingAssociations[this.associationIndex-direction].id) != null){
					document.getElementById("ProductInfoImage_"+this.merchandisingAssociations[this.associationIndex-direction].id).value = this.merchandisingAssociations[this.associationIndex].thumbnail;
					document.getElementById("ProductInfoImage_"+this.merchandisingAssociations[this.associationIndex-direction].id).id = "ProductInfoImage_" + this.merchandisingAssociations[this.associationIndex].id;
				}				
				...
				if(document.getElementById("ProductInfoPrice_"+this.merchandisingAssociations[this.associationIndex-direction].id) != null){
					document.getElementById("ProductInfoPrice_"+this.merchandisingAssociations[this.associationIndex-direction].id).value = this.merchandisingAssociations[this.associationIndex].skuOfferPrice;
					document.getElementById("ProductInfoPrice_"+this.merchandisingAssociations[this.associationIndex-direction].id).id = "ProductInfoPrice_" + this.merchandisingAssociations[this.associationIndex].id;
				}				
		...
		addBoth2ShopCart: function(){
			...
			if(this.baseItemParams.type == 'ItemBean'
				...
				if(-1 == sku){
					...
					updateParamObject(params,"quantity",this.baseItemParams.quantity,false,-1);
					shoppingActionsJS.saveAddedProductInfo(Math.abs(this.baseItemParams.quantity), this.baseItemParams.id, sku, shoppingActionsJS.selectedAttributesList['entitledItem_'+this.baseItemParams.id]);
				}
			}
			if (this.merchandisingAssociations[this.associationIndex].type=='ItemBean'
				...
				if(this.merchandisingAssociations[this.associationIndex].productId != undefined){
					shoppingActionsJS.saveAddedProductInfo(Math.abs(qtyspecified), this.merchandisingAssociations[this.associationIndex].productId, this.merchandisingAssociations[this.associationIndex].id, shoppingActionsJS.selectedAttributesList['entitledItem_'+this.merchandisingAssociations[this.associationIndex].id]);
				} else {
					shoppingActionsJS.saveAddedProductInfo(Math.abs(qtyspecified), this.merchandisingAssociations[this.associationIndex].id, this.merchandisingAssociations[this.associationIndex].id, shoppingActionsJS.selectedAttributesList['entitledItem_'+this.merchandisingAssociations[this.associationIndex].id]);
				}
				...
				for(idx=0;idx<this.merchandisingAssociations[this.associationIndex].components.length;idx++){
					...
					shoppingActionsJS.saveAddedProductInfo(Math.abs(associationQty), this.merchandisingAssociations[this.associationIndex].components[idx].id, this.merchandisingAssociations[this.associationIndex].components[idx].id, shoppingActionsJS.selectedProducts[this.merchandisingAssociations[this.associationIndex].components[idx].id]);
				}
				this.addItems2ShopCart(params);
			} else {
