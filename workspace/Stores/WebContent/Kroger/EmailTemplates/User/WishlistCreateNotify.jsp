...
--%>
	...
	<c:choose>
		...
		<c:otherwise>
			<fmt:message key="EMAIL_WISHLISTMESSAGE_NA" var="senderEmail"/>
		</c:otherwise>
	</c:choose>
											...
											<table style="border-collapse: collapse; border-spacing: 0; margin: 0 auto; width: 558px; color: #404040; font-size: 12px;" role="presentation">
												<tr>
													<td>
														...
														<p style="margin: 0; line-height: 14px; color: #404040; font-size: 12px;"><fmt:message key="EMAIL_SENDER_MESSAGE">
