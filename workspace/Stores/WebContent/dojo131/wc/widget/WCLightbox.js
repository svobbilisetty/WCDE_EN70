...
dojo.declare("wc.widget.WCLightboxDialog", dojox.image.LightboxDialog, {
    ...
    '</td>' +
    '<td class="headImg pointer" >' +
    '<a href="javascript:;" dojoAttachPoint="prevNode"><img dojoAttachPoint="prevIcon" class="ico" src="${imagePath}prev.gif" /></a>' +
    '</td>' +
    '<td class="headImg pointer">' +
    '<a href="javascript:;" dojoAttachPoint="nextNode"><img dojoAttachPoint="nextIcon" class="ico" src="${imagePath}next.gif" /></a>' +
    '</td>' +
    '<td class="spacer" >' +
    '<img src="${imagePath}separator.gif"/>' +
    '</td>' +
    '<td class="headImg pointer" >' +
    '<a href="javascript:;" dojoAttachPoint="closeNode"><img dojoAttachPoint="closeIcon" class="ico" src="${imagePath}close.gif" /></a>' +
    '</td>' +
    '</tr>' +
    '</tbody>' +
    '</table>' +
    ...
    startup: function(){
        ...
        this._animConnects = [];
        this.connect(this.nextNode, "onclick", "_nextNodeClickHandler");
        this.connect(this.prevNode, "onclick", "_prevNodeClickHandler");
        this.connect(this.closeNode, "onclick", "_closeNodeClickHandler");
