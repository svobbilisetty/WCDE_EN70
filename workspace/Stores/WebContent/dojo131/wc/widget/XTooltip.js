...
wc.widget.showXTooltip = function(innerHTML,aroundNode,position){
	if(!wc.widget._masterXTT){ wc.widget._masterXTT = new wc.widget._MasterXTooltip();};
...
dojo.declare(
	...
	connectId: [],
		...
		open: function(/*DomNode*/ target){
			...
			dojo.connect(wc.widget._masterXTT.domNode, "onmouseout", this,"_onMouseLeave");
			dojo.connect(target, "onkeydown", this,"_onKeyDown");
			var tooltip = this;			
