			...
			*/
			...
			function hideDetails() {
				...
				if (!parent.refreshAction) {
					...
					parent.document.getElementById('previewFrames').rows = "74,*";
			...
			function showDetails() {
				...
				parent.document.getElementById('previewFrames').rows = "175,*";
				...
				if (storeFrame != null) {
					if (storeFrame.document.getElementById("generateURL") != null) {
						if (storeFrame.document.getElementById("generatedURLDialog") != null) {
							if (storeFrame.document.getElementById("generatedURLDialog").style.display == 'none') {
								storeFrame.document.getElementById("generateURL").style.display = 'block';
						...
						node.innerHTML = 
								"<div class='sp_header_top' style='width: 550px;'>" + 
									"<div class='sp_header'>" + 
										...
										"<a id='closeGenerateURL' href='javascript:parent.frames[0].hideElementById(&#39generateURL&#39)'>" +
											...
											"<div class='sp_rightContainer'>" +
												...
												"<a id='sp_cancelGenerateURL' class='sp_light_button'" +
													...
													"onmouseover='parent.frames[0].buttonHover(&#39cancelGeneratedURLLeft&#39,&#39cancelGeneratedURLRight&#39, 1)'" +
												 	"href='javascript:parent.frames[0].hideElementById(&#39generateURL&#39)'>" +
			...
			function showGeneratedURLPopup(generatedURLData) {
				...
				if (storeFrame != null) {
					if (storeFrame.document.getElementById("generatedURLDialog") != null) {
						storeFrame.document.getElementById("generatedURLDialog").style.display='block';						
						...
						node.innerHTML = 
								"<div class='sp_header_top' style='width: 550px;'>" + 
									"<div class='sp_header'>" + 
										"<fmt:message key='storePreviewGenerateURLDialogTitle' bundle='${resources}' />" +
										"<a id='closeGeneratedURL' href='javascript:parent.frames[0].hideElementById(&#39generatedURLDialog&#39)'>" +
											"<div class='sp_close'></div>" +
										"</a>" +
									"</div>" +
									"<div class='sp_whitespace_background' style='width:532px;'>" +
										...
										"<div class='sp_optionsContainer'>" +
											"<div class='sp_rightContainer'>" +
												"<a id='closeGeneratedURL2' class='sp_light_button'" +
													...
													"href='javascript:parent.frames[0].hideElementById(&#39generatedURLDialog&#39)'>" +
					...
					dojo.xhrPost({
						...
						load: function(url) {
							dojo.io.script.get({
								...
								load: function(data) {
									storeFrame.document.getElementById("generateURL").style.display='none';
