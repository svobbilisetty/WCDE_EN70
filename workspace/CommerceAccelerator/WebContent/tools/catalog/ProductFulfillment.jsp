   ...
   if(productRefNum != null){
	...
	if( (strBaseItemId != null) &&(strBaseItemId.length()>0))
	{
		...
		try{
   		...
   		}catch(javax.ejb.ObjectNotFoundException e2){
