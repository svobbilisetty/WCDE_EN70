...
<FRAMESET BORDER=0 FRAMEBORDER=NO ID=frameset1 NAME=frameset1 ROWS="76,*,33" ONLOAD=onLoad()>
	<FRAME NAME=titleFrame   TITLE="<%= UIUtil.toHTML( (String)rbProduct.get("ProductUpdateDialog_FrameTitle_1")) %>" SRC="/webapp/wcs/tools/servlet/ProductUpdateTitle?menuXML=catalog.CatalogMenuProduct&catgroupID=<%=catgroupID%>">
