  ...
  try {
   ...
   try{
   	...
   	if(productRefNum != null){
   		...
   		cesAB.setInitKey_catalogEntryId( productRefNum );
   		cesAB.refreshCopyHelper ();
    ...
    if (parent.get("weightSelectNumberMessage", false))
       {
        ...
        alertDialog("<%= UIUtil.toJavaScript((String)productResource.get("weightSelectNumberMessage"))%>");
    ...
    if (parent.get("nominalQuantitySelectNumberMessage", false))
       {
        ...
        alertDialog("<%= UIUtil.toJavaScript((String)productResource.get("nominalQuantitySelectNumberMessage"))%>");
...
<H1><%=UIUtil.toHTML((String)productResource.get("catentShipTitle"))%></H1>
...
<TABLE cols=6>   
    ...
    <TR>
           <TD colspan="4">
               <BR><label for='weight'><%=UIUtil.toHTML((String)productResource.get("weight"))%></label>
           </TD>
    </TR>
    <TR>
           <TD colspan="4">
    ...
    <TR>
           <TD colspan="4">
               <label for='weightmeasure'><%=UIUtil.toHTML((String)productResource.get("weightmeasure"))%></label>
           </TD>
    </TR>
    <TR>
           <TD colspan="4">
    ...
    <TR>
           <TD colspan="4">
           <BR><label for='quantitymultiple_unitofmeasure'><%=UIUtil.toHTML((String)productResource.get("quantitymultiple_unitofmeasure"))%></label>
           </TD>
    </TR>
    <TR>
           <TD colspan="4">
    ...
    <TR>
           <TD colspan="4">
               <BR><label for='nominalquantity'><%=UIUtil.toHTML((String)productResource.get("nominalquantity"))%></label>
           </TD>
    </TR>
    <TR>
           <TD colspan="4">
   ...
   <TR>
           <TD colspan="4">
           <BR><label for='quantitymeasure_unitofmeasure'><%=UIUtil.toHTML((String)productResource.get("quantitymeasure_unitofmeasure"))%></label>
           </TD>
    </TR>
    <TR>
           <TD colspan="4">
