...
<%
		...
		Enumeration eValues = abValues.findByCatalogEntry(bnItem.getCatalogEntryReferenceNumberInEJBType());
		while (eValues.hasMoreElements())
		{
			...
			{
				Long lAttrId  = abValues.getAttributeReferenceNumberInEJBType();
				Integer iLang = abValues.getLanguage_idInEJBType();
				Long lValueId = abValues.getAttributeValueReferenceNumberInEJBType();
