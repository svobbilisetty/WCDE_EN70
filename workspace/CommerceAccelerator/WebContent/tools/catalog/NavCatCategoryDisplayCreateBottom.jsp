...
<TITLE><%=UIUtil.toHTML((String)rbCategory.get("NavCatCategoryDisplayCreateBottom_Title"))%></TITLE>
...
<%
			...
			if (strMessage.equals("msgNavCatCategoryDisplayCreateControllerCmdFinished") ||
				 strMessage.equals("msgNavCatCategoryDisplayUpdateControllerCmdFinished"))
			{
%>
				top.goBack();
<%
...
%>
	...
	// okButton() 
	//
	// - this function processes a click of the ok button
	//////////////////////////////////////////////////////////////////////////////////////
	function okButton()
	{
		parent.categoryDisplayContents.okButton();
	} 
	...
	<TABLE WIDTH=100% HEIGHT=35 BORDER=0 CELLPADDING=0 CELLSPACING=2 >
		<TR VALIGN=MIDDLE WIDTH=100%>
			...
			<TD ALIGN=RIGHT VALIGN=MIDDLE WIDTH=100%>
				<BUTTON NAME="okButtonName" ID="dialog" onclick="okButton()"><%=UIUtil.toHTML((String)rbCategory.get("NavCat_OK"))%></BUTTON>
				&nbsp;
				<BUTTON NAME="cancelButtonName" ID="dialog" onclick="cancelButton()"><%=UIUtil.toHTML((String)rbCategory.get("NavCat_Cancel"))%></BUTTON>
			</TD>
			<tr><td class=dottedLine height="1" colspan=10 width=100%></td></tr>
		</TR>
	</TABLE>
