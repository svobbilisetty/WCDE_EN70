...
<TITLE><%=UIUtil.toHTML((String)rbCategory.get("NavCatCategoryDisplayBottom_Title"))%></TITLE>
...
<%
		if (strMessage != null) 
		{ 
			if ( strMessage.equals("msgNavCatCategoryDisplaySequenceControllerCmdFinished") == false)
			{
%>
...
<%
			...
			if (strMessage.equals("msgNavCatCategoryDisplayDeleteControllerCmdFinished"))
			{
%>
				if (parent.categoryDisplayContents.refresh) parent.categoryDisplayContents.refresh("none");
<%
			}
			else if (strMessage.equals("msgNavCatCategoryDisplaySequenceControllerCmdFinished"))
			{
%>
				if (parent.categoryDisplayContents.refresh) parent.categoryDisplayContents.refresh("<%=strResult%>");
<%
			}
		}
%>
	...
	{
		parent.categoryDisplayContents.refresh("close");
	} 
