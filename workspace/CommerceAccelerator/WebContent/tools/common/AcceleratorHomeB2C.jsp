	...
	<table class="entry_table" border="0" cellpadding="0" cellspacing="0" width="899">
		<tbody>									
			...
			<tr>
				...
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("b2c_sec2_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("b2c_sec2_list") %>
					</ul>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="entry_divider" width="1"></td>			
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("b2c_sec5_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("b2c_sec5_list") %>
					</ul>
				</td>				
			</tr>
			<tr>
				<td class="entry_title" width="449"><%= resourceBundle.get("title_operations") %></td>				
				<td class="entry_divider" width="1">
				</td>
