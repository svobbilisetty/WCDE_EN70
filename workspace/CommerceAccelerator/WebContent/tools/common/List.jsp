...
<%!
   ...
   public String addHiddenVars()
   {
        ...
        sb.append("<INPUT TYPE='hidden' NAME='selected' VALUE='" + selectedParm + "'>\n");
        sb.append("<INPUT TYPE='hidden' NAME='orderby' VALUE='" + orderByParm + "'>\n");
        sb.append("<INPUT TYPE='hidden' NAME='ob' VALUE='" + orderByParm + "'>\n");
        sb.append("<INPUT TYPE='hidden' NAME='CTS' VALUE='"+ System.currentTimeMillis()+"'>\n");
        sb.append("<INPUT TYPE='hidden' NAME='startindex' VALUE=''>\n");
        sb.append("<INPUT TYPE='hidden' NAME='listsize' VALUE='" + listsizeParm + "'>\n");
        sb.append("<INPUT TYPE='hidden' NAME='refnum' VALUE='" + refnumParm + "'>\n");
        sb.append("<INPUT TYPE='hidden' NAME='ActionXMLFile' VALUE='" + actionXMLFileParm + "'>\n");
        return sb.toString();
   }
