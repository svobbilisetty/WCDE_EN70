...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("StorefrontUsageReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
	 ...
	 saveStartDateEndDate("enquiryPeriod");
         ...
         setReportFrameworkParameter("XMLFile","reporting.StorefrontUsageReportOutputDialog");
         setReportFrameworkReportXML("reporting.StorefrontUsageReport");
         setReportFrameworkReportName("StorefrontUsageReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("StorefrontUsageReportInputViewTitle") %></H1>
   <%=reportsRB.get("StorefrontUsageReportDescription")%>
   <p>
