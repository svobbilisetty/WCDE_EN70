...
<table CELLPADDING="0" CELLSPACING="0" BORDER="0" HEIGHT="100%" WIDTH="100%">
    <tr>
        ...
        <table CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="100%" HEIGHT="1%">
            ...
            <tr>
                <td class="entry_space">&nbsp;&nbsp;&nbsp;</td>
                <td NOWRAP class="entry_text"><a href="/webapp/wcs/tools/servlet/DialogView?XMLFile=reporting.StorefrontUsageReportDialog&HostedStoreId=<%=HostedStoreId%>"><%=resourceBundle.get("StoreReportsStorefrontUsageReportTitle")%></a></td>
                <td CLASS="entry_space">&nbsp;&nbsp;&nbsp;</td>
            ...
            <tr>
                <td class="entry_space">&nbsp;&nbsp;&nbsp;</td>
                <td NOWRAP class="entry_text"><a href="/webapp/wcs/tools/servlet/DialogView?XMLFile=reporting.CPOrderStatusReportDialog&HostedStoreId=<%=HostedStoreId%>"><%=resourceBundle.get("StoreReportsOrderStatusReportTitle")%></a></td>
                <td CLASS="entry_space">&nbsp;&nbsp;&nbsp;</td>
            ...
            <tr>
                <td class="entry_space">&nbsp;&nbsp;&nbsp;</td>
                <td NOWRAP class="entry_text"><a href="/webapp/wcs/tools/servlet/DialogView?XMLFile=reporting.CPOrderItemStatusReportDialog&HostedStoreId=<%=HostedStoreId%>"><%=resourceBundle.get("StoreReportsOrderItemStatusReportTitle")%></a></td>
                <td CLASS="entry_space">&nbsp;&nbsp;&nbsp;</td>
