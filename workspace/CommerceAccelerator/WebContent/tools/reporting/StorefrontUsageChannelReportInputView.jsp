...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("StorefrontUsageChannelReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
	 ...
	 saveStartDateEndDate("enquiryPeriod");
         ...
         setReportFrameworkParameter("XMLFile","reporting.StorefrontUsageChannelReportOutputDialog");
         setReportFrameworkReportXML("reporting.StorefrontUsageChannelReport");
         setReportFrameworkReportName("StorefrontUsageChannelReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("StorefrontUsageChannelReportInputViewTitle") %></H1>
   <%=reportsRB.get("StorefrontUsageChannelReportDescription")%>
   <p>
