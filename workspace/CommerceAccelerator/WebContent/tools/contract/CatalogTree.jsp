...
<%
  ...
  String baseContractParm = "";
   try {
     baseContractParm = contractCommandContext.getRequestProperties().getString("baseContract");
...
<frameset id="catalogFilterMainFrame" framespacing="0" border="0" frameborder="0" rows="20%, 80%, 0%" onload="init();">
   <frame name="titleFrame" id="titleFrame" src="/webapp/wcs/tools/servlet/ContractCatalogFilterTitlePanel?contractId=<%=contractId%>&fromContractList=<%= baseContractParm%>&accountId=<%= accountId %>" name="titleFrame" title="<%=UIUtil.toJavaScript((String)contractsRB.get("catalogTreeTitlePanel"))%>">
