...
try
{
   ...
   if ( sab.getStoreType().equals( "SHS" ) ) {
	  ...
	  com.ibm.commerce.base.objects.ServerJDBCHelperAccessBean JDBChelper = new com.ibm.commerce.base.objects.ServerJDBCHelperAccessBean();
