...
<%
   ...
   if (requestProperties != null) {
      fAccountHolderMemberId = (String)requestProperties.getString("org");
   }
%>
...
function onload ()
{
  ...
  //alert("<%=fAccountHolderMemberId%>");
  //alert("<%=foundAccountId%>");
  //alert("<%=accountId%>");
  //alert("<%=storeEntityId%>");

  //alert("<%=pPStoreMemberId%>");
  //alert("<%=pPStoreIdentity%>");
