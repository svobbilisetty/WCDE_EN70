...
<%
	...
	if (requestProperties != null) {
		contactId = (String)requestProperties.getString("ContactId");
	}
...
<title><%= contractsRB.get("accountCustomerContactDetailPrompt") %></title>
</head>
...
<% if (!contactId.equals("")) { %>
	<table BORDER=0 id="AccountCustomerContactDetailPanel_Table_1">
	  <tr>
		<td VALIGN=TOP ALIGN=LEFT id="AccountCustomerContactDetailPanel_TableCell_1"><%= contractsRB.get("accountAddressDetailPrompt") %></td>
	</tr>
	<tr>
		<td VALIGN=TOP ALIGN=LEFT id="AccountCustomerContactDetailPanel_TableCell_2">
