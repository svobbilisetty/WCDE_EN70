...
<frameset rows="36%,20%,20%,24%" frameborder="no" border="0" framespacing="0">
   <frame src="ContractPaymentDialogPaymentPolicySelectionPanelView?accountId=<%=accountId%>" title="<%= UIUtil.toJavaScript(contractsRB.get("contractPaymentFormSelectionPanelTitle")) %>" name="selectionBody" scrolling="auto" noresize>
   ...
   <frame src="ContractPaymentDialogAddressSelectionPanelView?accountId=<%=accountId%>" title="<%= UIUtil.toJavaScript(contractsRB.get("contractPaymentFormAddressSelectionPanelTitle")) %>" name="AddressSelectionBody" scrolling="auto" noresize>
