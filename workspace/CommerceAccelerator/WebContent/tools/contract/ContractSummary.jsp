...
<%
   ...
   <%if(ContractCmdUtil.isBuyerContract(usage)){%>
     <% if (contractId.equals(customerContractId)) { %>
        <h3><%= contractsRB.get("customerContractLabel") %> <%= contract.getContractName() %></h3>
     <% } else { %>
        <h3><%= contractsRB.get("baseContractLabel") %> <%= contract.getContractName() %></h3>
     <% } %>
      <h4><%= contractsRB.get("contractGeneralPanelPrompt") %></h4>

      <%= contractsRB.get("summaryContractName") %> <i><%= contract.getContractName() %></i><br />
      <% if (contract.getContractTitle() != null) { %>
         <%= contractsRB.get("summaryContractShortDescription") %> <i><%= contract.getContractTitle() %></i><br />
      <% } else { %>
   ...
   %>
     ...
     <% if (contractId.equals(customerContractId)) { %>
        <h3><%= contractsRB.get("delegationGridLabel") %> <%= contract.getContractName() %></h3>
     <% } else { %>
        <h3><%= contractsRB.get("baseDelegationGridLabel") %> <%= contract.getContractName() %></h3>
     <% } %>
      <h4><%= contractsRB.get("delegationGridGeneralPanelPrompt") %></h4>

      <%= contractsRB.get("summarydelegationGridName") %> <i><%= contract.getContractName() %></i><br />
      <% if (contract.getContractTitle() != null) { %>
         <%= contractsRB.get("summarydelegationGridShortDescription") %> <i><%= contract.getContractTitle() %></i><br />
      <% } else { %>
...
%>
  <h4><%= contractsRB.get("delegationGridRemarksTitle") %></h4>
   ...
   <% } else { %>
      <i><script type="text/javascript">document.writeln(decodeNewLinesForHtml('<%= UIUtil.toJavaScript(contract.getContractComment()) %>'))
</script></i><br />
   <% }
...
<%if(ContractCmdUtil.isReferralContract(usage) ){%>
   <% try{
      ...
      <%= contractsRB.get("distributorName") %> <i><%= distContract.getContractName() %></i><br />
      <% if (distContract.getContractTitle() != null) { %>
         <%= contractsRB.get("distributorShortDescription") %> <i><%= distContract.getContractTitle() %></i><br />
      <% } else { %>
   ...
   <%= contractsRB.get("resellerName") %> <i><%= resellerContract.getContractName() %></i><br />
   <% if (resellerContract.getContractTitle() != null) { %>
      <%= contractsRB.get("resellerShortDesc") %> <i><%= resellerContract.getContractTitle() %></i><br />
   <% } else { %>
...
REMOVE THIS LINE TO ADD THE HANDLING CHARGES INTO THE PAGE -->
  ...
  <h4><%= contractsRB.get("contractRemarksTitle") %></h4>
   ...
   <% } else { %>
      <i><script type="text/javascript">document.writeln(decodeNewLinesForHtml('<%= UIUtil.toJavaScript(cdb.getContractComment()) %>'))
</script></i><br />
   <% } %>
   <%
