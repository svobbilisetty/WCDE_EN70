...
<%= comm.addDlistColumn(calcCode.getCode(), "javascript:changeCalcCode(" + calcCode.getCalculationCodeIdInEJBType() + ")") %>
<%	} else { %>
<%= comm.addDlistCheck(calcCode.getCalculationCodeId() + "|N", "parent.setChecked();selectCalcCode()") %>
<%= comm.addDlistColumn(calcCode.getCode(), "javascript:displayCalcCode(" + calcCode.getCalculationCodeIdInEJBType() + ")") %>
<%  } %>
