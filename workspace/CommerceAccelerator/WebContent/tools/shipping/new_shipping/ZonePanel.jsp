...
%>
	    panelURL = "<%= ShippingConstants.URL_ZONE_CHANGE_DIALOG_VIEW + ShippingConstants.PARAMETER_ZONE_ID + "=" + zoneId + "&" + ShippingConstants.PARAMETER_COUNTRY_NAME + "=" %>" + countryName;
<%
	}
%>
