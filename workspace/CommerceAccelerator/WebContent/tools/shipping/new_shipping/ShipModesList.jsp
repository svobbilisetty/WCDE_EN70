...
<%		if (shipMode.getStoreEntityIdInEJBType().equals(fStoreId)) { %>
...
<%		if (shipMode.getStoreEntityIdInEJBType().equals(fStoreId)) { %>
<%= comm.addDlistColumn(shipMode.getCode(), "javascript:changeShipMode(" + shipMode.getShippingModeIdInEJBType() + ")") %>
<%		} else { %>
<%= comm.addDlistColumn(shipMode.getCode(), "javascript:displayShipMode(" + shipMode.getShippingModeIdInEJBType() + ")") %>
<% } %>
