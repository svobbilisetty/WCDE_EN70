...
function newCalcRule () {
   ...
   var panelURL = "<%= ShippingConstants.URL_CALCRULE_WIZARD_VIEW + "&" + ShippingConstants.PARAMETER_CALCCODE_ID + "=" + calcCodeId %>";
	if (top.setContent) {
...
function changeCalcRule() {
	...
	if (calcRuleId != -1) {
	    ...
	    var panelURL = "<%= ShippingConstants.URL_CALCRULE_WIZARD_VIEW + "&" + ShippingConstants.PARAMETER_CALCRULE_ID + "=" %>" + calcRuleId + "<%= "&" + ShippingConstants.PARAMETER_CALCCODE_ID + "=" + calcCodeId %>" ;
...
function displayCalcRule() {
	...
	if (calcRuleId != -1) {
	    ...
	    var panelURL = "<%= ShippingConstants.URL_CALCRULE_DETAILS_WIZARD_VIEW + "&amp;" + ShippingConstants.PARAMETER_CALCRULE_ID + "=" %>" + calcRuleId + "<%= "&amp;" + ShippingConstants.PARAMETER_CALCCODE_ID + "=" + calcCodeId %>" + "&amp;<%=ShippingConstants.PARAMETER_READONLY%>=true";
