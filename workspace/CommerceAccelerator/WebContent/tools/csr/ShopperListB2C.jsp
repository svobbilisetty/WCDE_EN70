...
try {
	...
	String logonid		= jspHelper.getParameter("logonid");
	String firstName	= jspHelper.getParameter("firstName");
	String lastName	= jspHelper.getParameter("lastName");
	String phone		= jspHelper.getParameter("phone");	
	String email		= jspHelper.getParameter("email");
	String city			= jspHelper.getParameter("city");
	String zip			= jspHelper.getParameter("zip");

	String orderByParam = jspHelper.getParameter("orderby");
	String passwordReset = jspHelper.getParameter("passwordReset");
	String logonidST 	= jspHelper.getParameter("logonidSearchType");
	String firstNameST 	= jspHelper.getParameter("firstNameSearchType");
	String lastNameST 	= jspHelper.getParameter("lastNameSearchType");
	String phoneST 		= jspHelper.getParameter("phoneSearchType");
	String emailST 		= jspHelper.getParameter("emailSearchType");
	String cityST 		= jspHelper.getParameter("citySearchType");
	String zipST 		= jspHelper.getParameter("zipSearchType");
...
<form name='ShopperListForm' id='ShopperListForm'>
	...
	%>
		...
		<%= comm.startDlistRow(rowselect) %>
			...
			<%= comm.addDlistColumn(userInfo[i][0], "none") %>
			<% if (nameOrder.indexOf("first") < nameOrder.indexOf("last")) { %>
