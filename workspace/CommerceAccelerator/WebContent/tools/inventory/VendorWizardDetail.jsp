...
function initialize()
{
  ...
  %>
   ...
   if (detail != null){
    ...
    vendorDetailList[numRows] = detail;
     ...
     vendorDetailList[numRows].formattedExpectedDate = '<%= formattedExpectedDate %>';
     //end format date
  ...
  if (updatedRow != null){
    ...
    vendorDetailList[updatedRow.rowNum].formattedExpectedDate = '<%= formattedExpectedDate %>';
    //end format date
