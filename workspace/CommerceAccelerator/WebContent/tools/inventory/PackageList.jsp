...
//}
    ...
    function packageNew(){	
        ...
        url += "&orderNumber=" + <%=orderNum%> + "&releaseNumber=" + <%=releaseNum%> + "&shipmodeId=" + <%=shipIdr%>;
	...
	redirectURL += "&orderNumber=" + <%=orderNum%> + "&releaseNumber=" + <%=releaseNum%> + "&shipmodeId=" + <%=shipIdr%>;
	...
	if (row == null) {
        ...
        url += "&manifestId=" + manifestId + "&orderNumber=" + <%=orderNum%> + "&releaseNumber=" + <%=releaseNum%>;
