...
<%!
	...
	private void copyOrderItemProperties(String origOrderItemId, String copyOrderItemId) {
		try {
			...
			copyOrderItemAB.commitCopyHelper();
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
...
//		//end orderEditBegin
		...
		//		bkupOrderBean.refreshCopyHelper();
		...
		//		}
		//		bkupOrderBean.commitCopyHelper();
