...
<jsp:include page="ActiveOrganization.jsp" flush="true" /> <br />
...
<form name="PromotionCodeForm" method="post" action="PromotionCodeManage">
	...
	<input type="hidden" name="URL" value="/webapp/wcs/tools/servlet/NewDynamicListView?ActionXMLFile=order.orderPromotionCodesPageB2B&cmd=OrderPromotionCodesPageB2B&firstOrderId=<%=firstOrderId%>" />
	<input type="hidden" name="errorViewName" value="OrderPromotionCodesPageB2B" /> 
