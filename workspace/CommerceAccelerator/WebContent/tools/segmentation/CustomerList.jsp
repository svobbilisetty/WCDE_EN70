...
function loadView (view) {
	...
	parameters.<%= SegmentConstants.PARAMETER_SEGMENT_ID %> = "<%= segmentId %>";
...
function getUserNLSTitle () {
	return finderChangeSpecialText("<%= UIUtil.toJavaScript((String)segmentsRB.get("customerListPromptWithSegmentName")) %>", "<%= UIUtil.toJavaScript((String)segmentDataBean.getSegmentName()) %>");
}
<%	} %>
//-->
</script>
