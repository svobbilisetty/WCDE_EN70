...
function removeCustomers () {
	...
	parent.location.href = "<%= UIUtil.getWebappPath(request) %>NewDynamicListView?ActionXMLFile=segmentation.ExplicitlyIncludedCustomerList&cmd=SegmentNotebookCustomersInclusionPanelView&segmentId=<%= segmentId %>";
}
