...
<input type="hidden" name="<%= SegmentConstants.PARAMETER_SEGMENT_ID %>" value="<%= segmentId %>">
<input type="hidden" name="<%= SegmentConstants.PARAMETER_LOGON_ID %>" value="<%= logonId %>">
<input type="hidden" name="<%= SegmentConstants.PARAMETER_FIRST_NAME %>" value="<%= firstName %>">
<input type="hidden" name="<%= SegmentConstants.PARAMETER_LAST_NAME %>" value="<%= lastName %>">
<input type="hidden" name="<%= SegmentConstants.PARAMETER_PHONE %>" value="<%= phone %>">
<input type="hidden" name="<%= SegmentConstants.PARAMETER_E_MAIL %>" value="<%= email %>">
<input type="hidden" name="<%= SegmentConstants.PARAMETER_CITY %>" value="<%= city %>">
<input type="hidden" name="<%= SegmentConstants.PARAMETER_ZIP_CODE %>" value="<%= zipCode %>">
<input type="hidden" name="<%= SegmentConstants.PARAMETER_SEARCH %>" value="<%= search %>">
