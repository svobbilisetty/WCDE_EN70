...
<%= comm.addDlistColumn(segment.getSegmentName(), "javascript:changeSegment('" + segment.getId() + "|Y')") %>
<%		} else if (migratedToCMC) { %>
<%= comm.addDlistCheck(segment.getId().toString() + "|C", "none") %>
<%= comm.addDlistColumn(segment.getSegmentName(), "none") %>
<%		} else { %>
<%= comm.addDlistCheck(segment.getId().toString() + "|N", "none") %>
<%= comm.addDlistColumn(segment.getSegmentName(), "none") %>
<%		} %>
<%= comm.addDlistColumn(segment.getDescription(), "none") %>
