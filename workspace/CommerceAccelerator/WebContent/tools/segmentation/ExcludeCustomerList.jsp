...
function removeCustomers () {
	...
	parent.location.href = "<%= UIUtil.getWebappPath(request) %>NewDynamicListView?ActionXMLFile=segmentation.ExplicitlyExcludedCustomerList&cmd=SegmentNotebookCustomersExclusionPanelView&segmentId=<%= segmentId %>";
}
