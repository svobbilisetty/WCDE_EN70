...
<%		} %>
	...
	if ("<%= initialLoad %>" != "Y" && <%= totalResultSize %> > <%= maxNumberOfResultForProductSearch %>) {
...
<%		} %>
	...
	if ("<%= initialLoad %>" != "Y" && <%= totalResultSize %> > <%= maxNumberOfResultForCategorySearch %>) {
...
<%		} %>
	...
	if ("<%= initialLoad %>" != "Y" && <%= totalResultSize %> > <%= maxNumberOfResultForPromotionSearch %>) {
...
<%		} %>
	...
	if ("<%= initialLoad %>" != "Y" && <%= totalResultSize %> > <%= maxNumberOfResultForContentSearch %>) {
