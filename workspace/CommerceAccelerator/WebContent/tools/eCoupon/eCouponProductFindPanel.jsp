...
function loadPanelData() {
   ...
   // something on the previous screen.
	document.productSearchForm.srSku.value = "<%= request.getParameter("srSku") %>";
	document.productSearchForm.srName.value = "<%= request.getParameter("srName") %>";
	document.productSearchForm.srShort.value = "<%= request.getParameter("srShort") %>";
	if ("<%= request.getParameter("srSkuType") %>" != "") {
		document.productSearchForm.srSkuType.options["<%= request.getParameter("srSkuType") %>"].selected = true;
	}
	if ("<%= request.getParameter("srNameType") %>" != "") {
		document.productSearchForm.srNameType.options["<%= request.getParameter("srNameType") %>"].selected = true;
	}
	if ("<%= request.getParameter("srShortType") %>" != "") {
		document.productSearchForm.srShortType.options["<%= request.getParameter("srShortType") %>"].selected = true;
	}
