...
<%	if (categoryIdentifier != null) { %>
		document.f1.categorySKU.value = "<%= categoryIdentifier %>";
<%	} else { %>
...
<%	if (minCatQty != null) { %>
	document.f1.minCatQty.value = "<%= minCatQty %>";
<%	} else { %>
...
<%	if (maxCatQty != null) { %>
	document.f1.maxCatQty.value = "<%= maxCatQty %>";
<%	} else { %>
...
<%	if (minCatAmt != null) { %>
	document.f1.minCatAmt.value = "<%= minCatAmt %>";
<%	} else { %>
...
<%	if (maxCatAmt != null) { %>
	document.f1.maxCatAmt.value = "<%= maxCatAmt %>";
<%	} else { %>
