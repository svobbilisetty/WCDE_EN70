...
function loadPanelData() {
	...
	document.categorySearchForm.srSku.value = "<%= request.getParameter("srSku") %>";
	document.categorySearchForm.srName.value = "<%= request.getParameter("srName") %>";
	document.categorySearchForm.srShort.value = "<%= request.getParameter("srShort") %>";
	if ("<%= request.getParameter("srSkuType") %>" != "") {
		document.categorySearchForm.srSkuType.options["<%= request.getParameter("srSkuType") %>"].selected = true;
	}
	if ("<%= request.getParameter("srNameType") %>" != "") {
		document.categorySearchForm.srNameType.options["<%= request.getParameter("srNameType") %>"].selected = true;
	}
	if ("<%= request.getParameter("srShortType") %>" != "") {
		document.categorySearchForm.srShortType.options["<%= request.getParameter("srShortType") %>"].selected = true;
	}
