...
function performCancel() {
	...
	urlparm.srSku = "<%= request.getParameter("srSku") %>";
	urlparm.srSkuType = "<%= request.getParameter("srSkuType") %>";
	urlparm.srName = "<%= request.getParameter("srName") %>";
	urlparm.srNameType = "<%= request.getParameter("srNameType") %>";
	urlparm.srShort = "<%= request.getParameter("srShort") %>";
	urlparm.srShortType = "<%= request.getParameter("srShortType") %>";
