...
{
	var submitErrorStatus = "<%= request.getParameter("SubmitErrorStatus") %>";
	if(submitErrorStatus == "true")
	{
		//error occured in controller command..check if its related to invalid deletions.
		var invalidDeletions = "<%= request.getParameter("invalidDeletions") %>";
		if(invalidDeletions == "true") {
		    ...
		    var list = "<%= request.getParameter("invalidDeletionsList") %>";
