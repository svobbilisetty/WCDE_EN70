...
{    
    <% if(emailActivityChange == true){
    %> 
        top.put("<%= EmailActivityConstants.PARAMETER_EMAIL_ACTIVITY_EMAILPROMOTIONID %>", "<%= emailActivityId %>");    
    <% } %>
...
{    
    <% if(emailActivityChange == true){
    %> 
        parent.put("<%= EmailActivityConstants.PARAMETER_EMAIL_ACTIVITY_EMAILPROMOTIONID %>", "<%= emailActivityId %>");    
    <% } %>
