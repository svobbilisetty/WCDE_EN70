...
function addFeature()
{
      var url = "/webapp/wcs/tools/servlet/DialogView?XMLFile=productAdvisor.AddFeaturesDialog&categoryId="+<%=categoryId%>+"&fromMetaphor=PC"+"&storeId="+"<%= storeId %>"+"&languageId="+"<%= languageId %>";
      if (top.setContent)
      {
