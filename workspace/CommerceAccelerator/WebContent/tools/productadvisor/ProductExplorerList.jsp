...
function addFeature()
{
      var url = "/webapp/wcs/tools/servlet/DialogView?XMLFile=productAdvisor.AddFeaturesDialog&categoryId="+<%=categoryId%>+"&fromMetaphor=PE&storeId="+<%= storeId %>+"&languageId="+<%= languageId %>;
      if (top.setContent)
      {
...
function savePanelData()
{
	...
	xml = xml + "<categoryId>" + <%=categoryId%> + "</categoryId>\n";
