...
<script language="javascript">
	var from = "<%= (String)request.getParameter("fromMetaphor")%>";
	if( from == "PC")
	{
	top.mccbanner.trail[top.mccbanner.counter-1].location = "/webapp/wcs/tools/servlet/DialogView?XMLFile=productAdvisor.ProductComparerDialog&categoryId="+<%= (String)request.getParameter("categoryId")%>+"&storeId="+<%= (String)request.getParameter("storeId")%>+"&languageId="+<%= (String)request.getParameter("languageId")%>+"&fromPACat=0";
	}
	else
	{
	top.mccbanner.trail[top.mccbanner.counter-1].location = "/webapp/wcs/tools/servlet/DialogView?XMLFile=productAdvisor.ProductExplorerDialog&categoryId="+<%= (String)request.getParameter("categoryId")%>+"&storeId="+<%= (String)request.getParameter("storeId")%>+"&languageId="+<%= (String)request.getParameter("languageId")%>+"&fromPACat=0";
	}
