...
<INPUT TYPE=HIDDEN NAME="aubdrule" VALUE="" id="WC_N_AucstyleBidcontrol_aubdrule_In_auctionStyleForm">
<INPUT TYPE=HIDDEN NAME="autype" VALUE="<%=selectedAuctionType%>" id="WC_N_AucstyleBidcontrol_autype_In_auctionStyleForm">
<TABLE ALIGN="LEFT" id="WC_N_AucstyleBidcontrol_Table_1">
	<TR>
	<TD id="WC_N_AucstyleBidcontrol_TableCell_1">
		<LABEL for="WC_N_AucstyleBidcontrol_BidRule_In_auctionStyleForm">
		<%= neg_properties.get("StyleBidRule") %>
		</LABEL><BR>
      	<SELECT name="BidRule" onChange="ChangeBidRule()" id="WC_N_AucstyleBidcontrol_BidRule_In_auctionStyleForm">
<%
...
<% if (RuleName != null && !RuleName.equals("")) {%>
	<TR><TD id="WC_N_AucstyleBidcontrol_TableCell_2">
		   <%= neg_properties.get("name") %>: <I><%=RuleName%></I> <BR>	
	</TD></TR>

	<TR><TD id="WC_N_AucstyleBidcontrol_TableCell_3">
		   <%= neg_properties.get("description") %>: <I><%=RuleDesc%></I> <BR>	
	</TD></TR>

	<TR><TD id="WC_N_AucstyleBidcontrol_TableCell_4">
<%
...
%>
	...
	<TR><TD id="WC_N_AucstyleBidcontrol_TableCell_5">
<%
...
%>
	<TR><TD id="WC_N_AucstyleBidcontrol_TableCell_6">
	       <TABLE class="list"  summary="<%= neg_properties.get("summaryText") %>" id="WC_N_AucstyleBidcontrol_Table_2">
	        <TR  class="list_roles">
	          <TD class="list_header" id="WC_N_AucstyleBidcontrol_TableCell_7"><%= neg_properties.get("RangeFrom") %> </TH>
	          <TD class="list_header" id="WC_N_AucstyleBidcontrol_TableCell_8"><%= neg_properties.get("RangeTo") %> </TH>
	          <TD class="list_header" id="WC_N_AucstyleBidcontrol_TableCell_9"><%= neg_properties.get("Increment") %> </TH>
		</TR>
<%
...
%>
		<TR>
		<TD CLASS="list_info1" headers="t1" id="WC_N_AucstyleBidcontrol_TableCell_10_<%=j%>">
            <%
		...
		<TD CLASS="list_info1" headers="t2" id="WC_N_AucstyleBidcontrol_TableCell_11_<%=j%>">
            <%
		...
		<TD CLASS="list_info1" headers="t3" id="WC_N_AucstyleBidcontrol_TableCell_12_<%=j%>">
            <%
