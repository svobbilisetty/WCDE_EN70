...
<%
	...
	if(rule_Type.equals("SB") || rule_Type.equals("O")) 
	{
			...
			out.println("parent.put('ruletype','" + rule_Type + "')");                        
...
<INPUT type="hidden" name="cntrlrule" value="<%= rule_Id %>" id="WC_N_BidruleInfo_cntrlrule_In_bidrulenotebookForm">
<INPUT type="hidden" name="rulename" value="<%= rule_Name %>" id="WC_N_BidruleInfo_rulename_In_bidrulenotebookForm">
<INPUT type="hidden" name="ruletype" value="<%= rule_Type %>" id="WC_N_BidruleInfo_ruletype_In_bidrulenotebookForm">

<TABLE ALIGN="LEFT" id="WC_N_BidruleInfo_Table_1">
	<TR>
	<TD id="WC_N_BidruleInfo_TableCell_1">
		<%= neg_properties.get("name") %>: <I><%= rule_Name %></I>	
	</TD>
	</TR>
	<TR>
