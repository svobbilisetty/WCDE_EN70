...
<%
	...
	// catentry
	if (objectType.equals(ECAttachmentConstants.EC_ATCH_OBJECT_TYPE_CATALOG_ENTRY)) {
	...
	// catalog
	} else if (objectType.equals(ECAttachmentConstants.EC_ATCH_OBJECT_TYPE_CATALOG)) {
	...
	// catgroup
	} else if (objectType.equals(ECAttachmentConstants.EC_ATCH_OBJECT_TYPE_CATALOG_GROUP)) {
