...
<%
	...
	Integer storeDefLangId = abStore.getLanguageIdInEJBType();
	...
	if (!strTool.equals("asset")) 
	{
		...
		abAttachmentRelation.refreshCopyHelper();
		
		atchRelUsageId = abAttachmentRelation.getAttachmentRelationUsageId().toString();
		atchRelSeq = abAttachmentRelation.getSequenceInEJBType().toString();
	}
...
%>
					aLanguages[aLanguages.length] = "<%=abAttachmentAssetLanguage.getLanguageIdInEJBType()%>";
<%
				}
