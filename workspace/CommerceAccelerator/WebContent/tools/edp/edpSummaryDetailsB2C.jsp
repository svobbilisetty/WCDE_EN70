...
<%@ page import="com.ibm.commerce.edp.activitylog.ActivityLoggerLocal" %>
...
<%!
  ...
  public String getOperation(ActivityLogRecordData aData){
     ...
     String result = "";
     if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_CREATE)){
        result = "operationCreate";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_REMOVE)){
        result = "operationRemove";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_CANCEL)){
        result = "operationCancel";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_UPDATE)){
        result = "operationUpdate";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_APPROVE)){
        result = "operationApprove";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_APPROVEANDDEPOSIT)){
        result = "operationApproveAndDeposit";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_DEPOSIT)){
        result = "operationDeposit";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_REFUND)){
        result = "operationRefund";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_REVERSE_REFUND)){
        result = "operationReverseRefund";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_REVERSE_APPROVAL)){
        result = "operationReverseApproval";
     }else if (operation.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_REVERSE_DEPOSIT)){
  ...
  public String getOperationResult(ActivityLogRecordData aData){
     ...
     String result = "";
     if (operationResult.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_RESULTS_SUCCESS)){
        result = "resultSuccess";
     }else if (operationResult.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_RESULTS_FAILED)){
        result = "resultFail";
     }else if (operationResult.equalsIgnoreCase(ActivityLoggerLocal.OPERATION_RESULTS_PENDING)){
  ...
  public String getType(ActivityLogRecordData aData){
     ...
     String result = "";
     if (type.equalsIgnoreCase(ActivityLoggerLocal.RECORD_TYPE_PAYMENT_INSTRUCTION)){
        result = "typePaymentInstruction";
     }else if (type.equalsIgnoreCase(ActivityLoggerLocal.RECORD_TYPE_PAYMENT)){
        result = "typePayment";
     }
     return result;
  }
