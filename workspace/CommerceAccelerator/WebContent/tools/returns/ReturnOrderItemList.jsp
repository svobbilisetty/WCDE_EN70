...
%>
      <FORM NAME="OrderItemSearchResultsList">
		...
		com.ibm.commerce.beans.DataBeanManager.activate(catEntDesc, request);
	     ...
	     {
		FormattedMonetaryAmountDataBean formattedAmount =  new FormattedMonetaryAmountDataBean(	new MonetaryAmount( orderItem.getPriceInEJBType(), currency ), (StoreAccessBean) store, cmdContext.getLanguageId() );
	...
	%>
		...
		<%
			FormattedQuantityAmountDataBean formattedQuantity = new FormattedQuantityAmountDataBean( new QuantityAmount( orderItem.getQuantityInEJBType().doubleValue(), currency ), (StoreAccessBean) store, cmdContext.getLanguageId() );
		%>
