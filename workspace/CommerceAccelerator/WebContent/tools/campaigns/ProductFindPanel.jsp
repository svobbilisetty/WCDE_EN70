...
function loadPanelData () {
	...
	with (document.productSearchForm) {
		...
		loadSelectValue(srPartNumberType, "<%= request.getParameter("srPartNumberType") %>");
		loadSelectValue(srNameType, "<%= request.getParameter("srNameType") %>");
		loadSelectValue(srShortDescriptionType, "<%= request.getParameter("srShortDescriptionType") %>");
		srPartNumber.focus();
	}
