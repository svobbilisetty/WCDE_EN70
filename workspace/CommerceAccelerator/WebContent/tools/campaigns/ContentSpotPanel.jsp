...
<iframe id="scheduleList" title="<%= UIUtil.toHTML((String)campaignsRB.get("contentScheduleListPrompt")) %>" frameborder="0" scrolling="no" src="<%= UIUtil.getWebappPath(request) %>NewDynamicListView?ActionXMLFile=campaigns.ContentSpotScheduleList&amp;cmd=ContentSpotSchedulePanelView&amp;orderby=name" width="100%" height="50%"></iframe>
