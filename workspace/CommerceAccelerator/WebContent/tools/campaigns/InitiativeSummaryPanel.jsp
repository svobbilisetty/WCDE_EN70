...
function loadInitiative () {
	...
	if (initiative != null) {
		...
		displayRow("<%= UIUtil.toJavaScript((String)campaignsRB.get("initiativeSummaryDescriptionPrompt")) %>", initiative.<%= CampaignConstants.ELEMENT_DESCRIPTION %>);
		displayRow("<%= UIUtil.toJavaScript((String)campaignsRB.get("initiativeSummaryCampaignPrompt")) %>", initiative.<%= CampaignConstants.ELEMENT_CAMPAIGN_NAME %>);
