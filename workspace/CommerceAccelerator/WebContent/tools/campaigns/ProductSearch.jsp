...
var resultLimit = "<%= request.getParameter("resultLimit") %>";
...
function performCancel () {
	...
	urlparm.srPartNumberType = "<%= request.getParameter("srPartNumberType") %>";
	urlparm.srNameType = "<%= request.getParameter("srNameType") %>";
	urlparm.srShortDescriptionType = "<%= request.getParameter("srShortDescriptionType") %>";
