...
<input name="<%= CampaignConstants.ELEMENT_ID %>" type="hidden" value="<%= request.getParameter(CampaignConstants.PARAMETER_COLLATERAL_ID) %>" id="WC_CollateralURLSegment_FormInput_<%= CampaignConstants.ELEMENT_ID %>_1"/>
<%	} %>
