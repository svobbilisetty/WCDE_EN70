...
function getInitiativeId () {
	return <%= request.getParameter(CampaignConstants.PARAMETER_INTV_ID) %>;
}

function getCampaignId () {
	return <%= request.getParameter(CampaignConstants.PARAMETER_CAMPAIGN_ID) %>;
}
...
function returnToInitiatives () {
	if (top.goBack) {
		...
		parent.location.replace("<%= CampaignConstants.URL_CAMPAIGN_INITIATIVES_VIEW %>" + "<%= request.getParameter(CampaignConstants.PARAMETER_CAMPAIGN_ID) %>");
	}
}
...
<input type="hidden" name="<%= CampaignConstants.PARAMETER_INTV_ID %>" value="<%= request.getParameter(CampaignConstants.PARAMETER_INTV_ID) %>" id="WC_MIstatistics_FormInput_<%= CampaignConstants.PARAMETER_INTV_ID %>_In_campaignStatsForm_1"/>
<input type="hidden" name="<%= CampaignConstants.PARAMETER_CAMPAIGN_ID %>" value="<%= request.getParameter(CampaignConstants.PARAMETER_CAMPAIGN_ID) %>" id="WC_MIstatistics_FormInput_<%= CampaignConstants.PARAMETER_CAMPAIGN_ID %>_In_campaignStatsForm_1"/>
