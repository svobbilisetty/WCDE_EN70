...
function loadCollateral () {
	...
	if (collateral.<%= CampaignConstants.ELEMENT_COLLATERAL_TYPE %> == "1") {
		...
		displayRow("<%= UIUtil.toJavaScript((String)campaignsRB.get("collateralPreviewMarketingText")) %>", collateral.<%= CampaignConstants.ELEMENT_COLLATERAL_MARKETING_TEXT %>);
		...
		displayRow("<%= UIUtil.toJavaScript((String)campaignsRB.get("collateralPreviewStaticText")) %>", collateral.<%= CampaignConstants.ELEMENT_COLLATERAL_MARKETING_TEXT %>);
	}
