...
function onLoad () {
	loadSelectValue(document.initiativeForm.<%= CampaignConstants.ELEMENT_INITIATIVE_TYPE %>, "<%= viewType %>");
	loadSelectValue(document.initiativeForm.initiativeCampaign, "<%= campaignId %>");
