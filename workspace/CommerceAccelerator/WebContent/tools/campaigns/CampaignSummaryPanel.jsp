...
function loadCampaign () {
	...
	if (campaign != null) {
		displayRow("<%= UIUtil.toJavaScript((String)campaignsRB.get("campaignSummaryNamePrompt")) %>", campaign.<%= CampaignConstants.ELEMENT_CAMPAIGN_NAME %>);
		displayRow("<%= UIUtil.toJavaScript((String)campaignsRB.get("campaignSummaryDescriptionPrompt")) %>", campaign.<%= CampaignConstants.ELEMENT_DESCRIPTION %>);
		displayRow("<%= UIUtil.toJavaScript((String)campaignsRB.get("campaignSummarySponsorPrompt")) %>", campaign.<%= CampaignConstants.ELEMENT_OWNER %>);
		displayRow("<%= UIUtil.toJavaScript((String)campaignsRB.get("campaignSummaryObjectivesPrompt")) %>", campaign.<%= CampaignConstants.ELEMENT_OBJECTIVE %>);
