...
<%= comm.addControlPanel("campaigns.EmsSelectionList", totalpage, totalsize, jLocale) %>
...
<%= comm.addDlistColumnHeading((String)campaignsRB.get(CampaignConstants.MSG_EMS_LIST_SCHEDULE_NUMBER_COLUMN), CampaignConstants.ORDER_BY_SCHEDULE_NUMBER, CampaignConstants.ORDER_BY_SCHEDULE_NUMBER.equals(orderByParm)) %>
<%= comm.endDlistRow() %>
<%
