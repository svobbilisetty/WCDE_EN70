...
function convertParametersToXML() {
	...
	CSEDITATT.store_id = "<%= store_id %>";
	CSEDITATT.transport_id = "<%= transport_id %>";
	CSEDITATT.profile_id= "<%= profile_id %>";
	ISEDITATT.profile_id= "<%= profile_id %>";
...
function validatePanelData() {
	...
	PROFILE.<%= MessagingSystemConstants.TC_PROFILE_STORE_ID %> 		= "<%= store_id %>";
	PROFILE.<%= MessagingSystemConstants.TC_PROFILE_TRANSPORT_ID %> 	= "<%= transport_id %>";
	PROFILE.<%= MessagingSystemConstants.TC_PROFILE_PROFILE_ID %> 		= "<%= profile_id %>";
	PROFILE.<%= MessagingSystemConstants.TC_PROFILE_MSGTYPE_ID %> 		= "<%= msgtype_id %>";
	PROFILE.<%= MessagingSystemConstants.TC_PROFILE_DEVICEFORMAT_ID %> 	= "<%= deviceformat_id %>";
	PROFILE.<%= MessagingSystemConstants.TC_PROFILE_LOWPRIORITY %> 		= "<%= lowpriority %>";
	PROFILE.<%= MessagingSystemConstants.TC_PROFILE_HIGHPRIORITY %> 	= "<%= highpriority %>";
