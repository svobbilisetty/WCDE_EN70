...
<table id="approval_rejection_comment_dialog_Table_1">
    ...
    <input TYPE="HIDDEN" NAME="aprv_act" VALUE="<%= aprv_act %>" id="approval_rejection_comment_dialog_FormInput_aprv_act_In_commentsForm_1">
    <input TYPE="HIDDEN" NAME="aprv_ids" VALUE="<%= aprv_ids %>" id="approval_rejection_comment_dialog_FormInput_aprv_ids_In_commentsForm_1">
    ...
    <input TYPE="HIDDEN" NAME="ActionXMLFile" VALUE="<%= ActionXMLFile %>" id="approval_rejection_comment_dialog_FormInput_ActionXMLFile_In_commentsForm_1">
    <input TYPE="HIDDEN" NAME="cmd" VALUE="<%= cmd %>" id="approval_rejection_comment_dialog_FormInput_cmd_In_commentsForm_1">
</form>
<script LANGUAGE="JavaScript">
<!--
