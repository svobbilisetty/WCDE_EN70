...
<%@ page import="com.ibm.commerce.fulfillment.objects.FulfillmentJDBCHelperAccessBean" %>
...
<%
    ...
    FulfillmentJDBCHelperAccessBean bFulfillmentCenter = new FulfillmentJDBCHelperAccessBean();
