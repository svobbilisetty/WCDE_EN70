...
function savePanelData(){
	if(createUpdateTheData()){
		...
		xml += "<createNew><%=createNew%></createNew>\n";
		xml += "<conceptId><%=conceptId%></conceptId>\n";
		xml += "<hasRootQuestion><%=hasRootQuestion%></hasRootQuestion>\n";
		xml += "<wasRootQuestion><%=rootQuestion%></wasRootQuestion>\n";
...
function validatePanelData(){
	...
	var hasRootQuestion = '<%=hasRootQuestion%>';
	var wasRootQuestion = '<%=rootQuestion%>';
