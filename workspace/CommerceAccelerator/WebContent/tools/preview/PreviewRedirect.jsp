...
<FRAMESET rows ="15%,85%" >
	<FRAME SRC="<%= header %>" TITLE="<%= UIUtil.toHTML((String)previewNLS.get("previewHeaderFrameTitle")) %>" />
	<FRAME SRC="<%= redirecturl %>"  TITLE="<%= UIUtil.toHTML((String)previewNLS.get("previewBodyFrameTitle")) %>"/> 
</FRAMESET>	
</HTML>
