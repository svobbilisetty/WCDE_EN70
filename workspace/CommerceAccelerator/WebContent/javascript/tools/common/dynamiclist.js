...
function addDlistCheckHeading(check,checkfnc){
	...
	if (check == true) {
		...
		document.write(';">');
		if (typeof(top.dlSelectDeselectAll) != 'undefined') {
			document.write('<div class="hidden-label">' + top.dlSelectDeselectAll + '</label>');
		}
	}
	document.writeln('</td>');
}
...
function addDlistCheck(name,fnc,value) {
	...
	if (typeof(top.dlSelectRow) != 'undefined') {
		document.writeln('<td class="' + list_check_style + '"><label><input type="checkbox"');
	} else {
	...
	if (typeof(top.dlSelectRow) != 'undefined') {
		document.write('/><div class="hidden-label">' + top.dlSelectRow + '</div></label></td>');
	} else {
		document.write('/></td>');
	}
