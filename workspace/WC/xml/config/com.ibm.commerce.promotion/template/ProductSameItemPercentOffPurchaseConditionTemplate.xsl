			...
			<Pattern impl="com.ibm.commerce.marketing.promotion.condition.Pattern">
				<Constraint impl="com.ibm.commerce.marketing.promotion.condition.Constraint">
					<WeightedRange impl="com.ibm.commerce.marketing.promotion.condition.WeightedRange">
						<LowerBound><xsl:value-of select="PromotionData/Elements/PurchaseCondition/Data/BaseQuantity + PromotionData/Elements/PurchaseCondition/Data/RewardQuantity" /></LowerBound>
						<UpperBound><xsl:value-of select="PromotionData/Elements/PurchaseCondition/Data/BaseQuantity + PromotionData/Elements/PurchaseCondition/Data/RewardQuantity" /></UpperBound>
						<Weight>1</Weight>
					</WeightedRange>
							...
							<AdjustmentFunction impl="com.ibm.commerce.marketing.promotion.reward.AdjustmentFunction">
								<FilterChain impl="com.ibm.commerce.marketing.promotion.condition.FilterChain">
									<Filter impl="com.ibm.commerce.marketing.promotion.condition.PriceComparisonFilter">
										...
										<NoOfItems><xsl:value-of select="PromotionData/Elements/PurchaseCondition/Data/RewardQuantity" /></NoOfItems>
									</Filter>
								</FilterChain>
