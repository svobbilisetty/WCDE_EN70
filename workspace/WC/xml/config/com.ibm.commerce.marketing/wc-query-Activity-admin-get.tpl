...
BEGIN_XPATH_TO_SQL_STATEMENT
	...
	sql=
		...
		WHERE
				...
				DMACTIVITY.DMACTTYPE_ID IN (0, 1, 2)
	...
	sql=
		...
		WHERE
		    ...
		    DMACTIVITY.DMACTTYPE_ID = ?ActivityType? AND
				...
				DMACTIVITY.DMTEMPLATETYPE_ID IS NULL AND
				DMELEMENTNVP.NAME = ?Name? AND
				UPPER(DMELEMENTNVP.VALUE) = UPPER(?CampaignElement/CampaignElementVariable/Value?)
    UNION
		SELECT 
				DISTINCT DMACTIVITY.$COLS:DMACTIVITY_ID_NAME$
		FROM
        ...
        DMACTIVITY.DMACTTYPE_ID = ?ActivityType? AND				
				...
				(UPPER(DMACTIVITY.NAME) = UPPER(?ActivityIdentifier/ExternalIdentifier/Name?) OR
				 UPPER(DMACTIVITY.DESCRIPTION) = UPPER(?Description?) )
    ORDER BY NAME	
 	dbtype=db2		
	sql=
		SELECT 
		...
		WHERE
		    ...
		    DMACTIVITY.DMACTTYPE_ID = ?ActivityType? AND
				...
				DMACTIVITY.DMTEMPLATETYPE_ID IS NULL AND
				DMELEMENTNVP.NAME = ?Name? AND
				(UPPER(DMELEMENTNVP.VALUE) = UPPER(CAST(?CampaignElement/CampaignElementVariable/Value? AS VARCHAR(254))) )
    UNION
		SELECT 
				DISTINCT DMACTIVITY.$COLS:DMACTIVITY_ID_NAME$
		FROM
        ...
        DMACTIVITY.DMACTTYPE_ID = ?ActivityType? AND				
				...
				(UPPER(DMACTIVITY.NAME) = UPPER(CAST(?ActivityIdentifier/ExternalIdentifier/Name? AS VARCHAR(64))) OR
				 UPPER(DMACTIVITY.DESCRIPTION) = UPPER(CAST(?Description? AS VARCHAR(254))) )				
    ORDER BY NAME 		
	...
	sql=
		...
		WHERE
		    ...
		    DMACTIVITY.DMACTTYPE_ID = ?ActivityType? AND
				...
				DMACTIVITY.DMTEMPLATETYPE_ID IS NULL AND
				DMELEMENTNVP.NAME = ?Name? AND
				(UPPER(DMELEMENTNVP.VALUE) LIKE UPPER(?CampaignElement/CampaignElementVariable/Value?) ESCAPE '+')
    UNION
		SELECT 
				DISTINCT DMACTIVITY.$COLS:DMACTIVITY_ID_NAME$
		FROM
        ...
        DMACTIVITY.DMACTTYPE_ID = ?ActivityType? AND				
				...
				(UPPER(DMACTIVITY.NAME) LIKE UPPER(?ActivityIdentifier/ExternalIdentifier/Name?) ESCAPE '+' OR
				 UPPER(DMACTIVITY.DESCRIPTION) LIKE UPPER(?Description?) ESCAPE '+' )				
    ORDER BY NAME	
 	dbtype=db2		
	sql=
		SELECT 
		...
		WHERE
		    ...
		    DMACTIVITY.DMACTTYPE_ID = ?ActivityType? AND
				...
				DMACTIVITY.DMTEMPLATETYPE_ID IS NULL AND
				DMELEMENTNVP.NAME = ?Name? AND
				(UPPER(DMELEMENTNVP.VALUE) LIKE UPPER(CAST(?CampaignElement/CampaignElementVariable/Value? AS VARCHAR(254))) ESCAPE '+')
    UNION
		SELECT 
				DISTINCT DMACTIVITY.$COLS:DMACTIVITY_ID_NAME$
		FROM
        ...
        DMACTIVITY.DMACTTYPE_ID = ?ActivityType? AND				
				...
				(UPPER(DMACTIVITY.NAME) LIKE UPPER(CAST(?ActivityIdentifier/ExternalIdentifier/Name? AS VARCHAR(64))) ESCAPE '+' OR
				 UPPER(DMACTIVITY.DESCRIPTION) LIKE UPPER(CAST(?Description? AS VARCHAR(254))) ESCAPE '+' )								
    ORDER BY NAME 		
...
BEGIN_XPATH_TO_SQL_STATEMENT
	...
	sql=
		...
		WHERE
				...
				DMACTIVITY.DMACTIVITY_ID = DMEXPFAMILY.DMACTIVITY_ID
