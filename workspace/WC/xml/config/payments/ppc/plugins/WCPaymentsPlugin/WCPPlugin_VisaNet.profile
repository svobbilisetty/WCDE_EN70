...
<Profile useWallet="false" enableTrace="true">
  ...
  <CollectPayment>
    ...
    <Parameter name="$PAN" sensitive="true"><CharacterText>{account}</CharacterText></Parameter>
    
    <!-- The expiry date in format YYYYMM -->
    <Parameter name="$EXPIRY"><CharacterText>{expire_year}{expire_month}</CharacterText></Parameter>
    
    <Parameter name="$ACCOUNTNUMBER"><CharacterText>{storeId}</CharacterText></Parameter>
    ...
    <Parameter name="$CARDVERIFYCODE" maxBytes="4" encoding="ASCII"><CharacterText>{cc_cvc}</CharacterText></Parameter>
    ...
    <Parameter name="$NUMPAYMENTS"><CharacterText>5</CharacterText></Parameter>
