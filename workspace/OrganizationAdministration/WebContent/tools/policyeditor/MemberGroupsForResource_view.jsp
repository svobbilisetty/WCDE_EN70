...
<%
  ...
  String resourceId= (String) request.getParameter("resourceId");
   memberGroupForPolicyBean.setResourceId(Integer.valueOf(resourceId)) ;
...
{
  for (var i=0; i < document.MemberGroupsForResourceViewForm.elements.length; i++) 
  {
     var e = document.MemberGroupsForResourceViewForm.elements[i];
...
<%= comm.addControlPanel("policyeditor.MemberGroupsForResourceView",totalpage,totalsize,locale) %>
<FORM NAME="MemberGroupsForResourceViewForm" action="" method="GET">
...
<P>
<% 
     out.println(UIUtil.toHTML((String)PolicyUtilityNLS.get("emptyMemberGroupsForResourceView"))); 
   }
%>
