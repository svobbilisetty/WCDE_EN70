...
<FORM NAME="submissionListForm" action="ApprovalSubmissionListView?" method="POST">
...
<%= comm.addDlistColumn(aList[i].getId().toString(), "javascript:top.setContent(getApprovalDetailsBCT(), top.getWebappPath() + 'DialogView?XMLFile=approvals.approvalSubmissionDetailsDialog&amp;aprv_ids=" +
...
<%= comm.endDlistTable() %>
   ...
   <INPUT TYPE="hidden" NAME="viewtask" VALUE="ApprovalSubmissionListView">
   <INPUT TYPE="hidden" NAME="lang" VALUE=<%= lang %>>
   <INPUT TYPE="hidden" NAME="aprv_ids" VALUE="">
   <INPUT TYPE="hidden" NAME="aprv_act" VALUE="">
</FORM>
