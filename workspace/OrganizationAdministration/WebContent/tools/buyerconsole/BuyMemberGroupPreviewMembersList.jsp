...
function getUserNLSTitle () {
	return finderChangeSpecialText("<%= UIUtil.toJavaScript((String)memberGroupListNLS.get("memberGroupPreviewMembersPromptWithSegmentName")) %>", "<%= UIUtil.toJavaScript((String)segmentDataBean.getSegmentName()) %>");
}
<% } %>
