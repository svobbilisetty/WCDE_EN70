		...
		<tbody>									
			...
			<tr>
				<td class="entry_text" valign="top" colspan="3">
					<%= resourceBundle.get("hcp_intro") %> <%= resourceBundle.get("helpText") %>
				</td>
			</tr>
			<tr>
				<td class="entry_title" width="449"><%= resourceBundle.get("title_hub") %></td>
				<td class="entry_divider" width="1"></td>
				<td class="entry_title" width="449"><%= resourceBundle.get("title_hosting") %></td>
			</tr>
			<tr>
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("hcp_sec1_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("hcp_sec1_list") %>
					</ul>
				</td>
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("hcp_sec2_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("hcp_sec2_list") %>
					</ul>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("hcp_sec3_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("hcp_sec3_list") %>
					</ul>
				</td>
				<td class="entry_divider" width="1"></td>				
