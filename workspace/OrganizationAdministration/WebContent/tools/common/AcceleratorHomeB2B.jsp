...
<%
	...
	String sec7List = "";
	if(isPMOperational){
	    sec7List = (String)resourceBundle.get("b2b_sec7_list");
	}
	else{
	    sec7List = (String)resourceBundle.get("b2b_sec7_list2");
	}
%>
		...
		<tbody>									
			...
			<tr>
				<td class="entry_text" valign="top" colspan="3">
					<%= resourceBundle.get("b2b_intro") %> <%= resourceBundle.get("helpText") %>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="entry_text" valign="top" width="449">
					...
					<ul class="entry_list">
						<%= resourceBundle.get("b2b_sec1_list") %>
					</ul>
				</td>
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
					...
					<ul class="entry_list">
						<%= resourceBundle.get("b2b_sec2_list") %>
					</ul>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("b2b_sec3_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("b2b_sec3_list") %>
					</ul>
				</td>
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
					...
					<ul class="entry_list">
						<%= resourceBundle.get("b2b_sec4_list") %>
					</ul>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("b2b_sec6_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("b2b_sec6_list") %>
					</ul>
				</td>			
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
