...
try {
	...
	Locale locale = (cmdContext == null ? Locale.getDefault() : cmdContext.getLocale());
...
<%
	for (int i=0; i<numOrgs; i++) {
		...
		try {
			...
			orgDN = dbOrganization.getDistinguishedName();
			out.println("   resultDNs[" + i + "] = '"
                    + UIUtil.toJavaScript(orgDN.toString())
                    + "';" );
		}
		catch (Exception e) {
			e.printStackTrace();
...
/////////////////////////////////////////////////////////////////////////////
// Function: getOrgDNList
// Desc.   : Return the list of Org DN(Distinguished Name)
//			 values from the search result
// Input   : void
// Output  : an array of Org DNs
/////////////////////////////////////////////////////////////////////////////
function getOrgDNList() {
