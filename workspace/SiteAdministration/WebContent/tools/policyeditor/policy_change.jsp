...
<TABLE>
  <TR>
    <TD ALIGN="LEFT"><STRONG><Label for="policyNameHeader"><%= UIUtil.toHTML((String)policyNLS.get("policyNameHeader")) %></Label></STRONG> </TH></TR>
  <TR>
    <TD><INPUT size="70" maxlength="128" name="policyName" value="<%= UIUtil.toHTML(polName) %>" id="policyNameHeader"></TD></TR>
  <TR>
    <TD ALIGN="LEFT"><STRONG><Label for="displayNameHeader"><%= UIUtil.toHTML((String)policyNLS.get("displayNameHeader")) %></Label></STRONG> </TH></TR>
  <TR>
    <TD><INPUT size="70" maxlength="128" name="policyDisplayName" value="<%= UIUtil.toHTML(polDisplayName) %>" id="displayNameHeader"></TD></TR>
  <TR>
    <TD ALIGN="LEFT"><STRONG><Label for="policyDescriptionHeader"><%= UIUtil.toHTML((String)policyNLS.get("policyDescriptionHeader")) %></Label></STRONG></TH></TR>
  <TR>
    <TD><INPUT size=70 maxlength="254" name="policyDescription" value="<%= UIUtil.toHTML(polDesc) %>" id="policyDescriptionHeader"></TD></TR>
  <TR>
    <TD ALIGN="LEFT"><STRONG><Label for="policyUserGroupHeader"><%= UIUtil.toHTML((String)policyNLS.get("policyUserGroupHeader")) %></Label></STRONG></TH></TR>
  <TR>
  ...
  <TR>
    <TD ALIGN="LEFT"><STRONG><LABEL for="resourceGroup1"><%= UIUtil.toHTML((String)policyNLS.get("policyResourceGroupHeader")) %></LABEL></STRONG></TH></TR>
  <TR>
    <TD>
...
%>
  ...
  <TR>
    <TD ALIGN="LEFT"><STRONG><LABEL for="actionGroup1"><%= policyNLS.get("policyActionGroupHeader") %></LABEL></STRONG></TH></TR>
  <TR>
    <TD>
...
%>
  ...
  <TR>
    <TD ALIGN="LEFT"><STRONG><LABEL for="relation1"><%= policyNLS.get("policyRelationshipHeader") %></LABEL></STRONG></TH></TR>
  <TR>
...
%>
        ><%= policyNLS.get("noneRelation") %></OPTION> 
<%        
...
%> 
    ...
    <INPUT TYPE="HIDDEN" NAME="resourceGroupId" value="<%= resourceGroupId %>">
    ...
    <INPUT TYPE="HIDDEN" NAME="origPolicyName" VALUE="<%= origPolicyName %>">
    <INPUT TYPE="HIDDEN" NAME="origPolicyDisplayName" VALUE="<%= origPolicyDisplayName %>">
</FORM>
