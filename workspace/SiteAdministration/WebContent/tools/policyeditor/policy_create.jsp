...
<TABLE>
  ...
  <TR>
    <TD><INPUT name="userGroup" size=70 value="" onFocus="document.createForm.find1.focus()" id="policyUserGroupHeader">
        <input type="button" value="<%= UIUtil.toHTML((String)policyNLS.get("userGroupFindButton")) %>" name="find1" onClick="goFind()" id="policyUserGroupHeader"></TD></TR>
  <TR>
...
<%
     ...
     {
%>   
       <OPTION value="" selected><%= policyNLS.get("noneResourceGroup") %></OPTION>
<%
     }
...
%>
  ...
  <TR>
    <TD ALIGN="LEFT"><STRONG><Label for="actionGroup1"><%= UIUtil.toHTML((String)policyNLS.get("policyActionGroupHeader")) %></Label></STRONG></TH></TR>
  <TR>
    <TD>
...
%> 
  ...
  <TR>
    <TD><SELECT name="relation" id="relation1">  
        <OPTION  value="" selected><%= policyNLS.get("noneRelation") %></OPTION> 
<%        
        if(haveResourceGroupId)
        {
...
%>
  <TR><TD ALIGN="LEFT"><STRONG><Label for="policyTypeHeader"><%= UIUtil.toHTML((String)policyNLS.get("policyTypeHeader")) %></Label></STRONG></TH></TR>
