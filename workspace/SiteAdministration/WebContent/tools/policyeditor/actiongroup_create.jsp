...
<TABLE>
  ...
  <TR>
    <TD ALIGN="LEFT"><STRONG><Label for="actiongroupNameHeader"><%= UIUtil.toHTML((String)policyNLS.get("actiongroupNameHeader")) %></Lebel></STRONG> </TD></TR>
  <TR>
    <TD><INPUT size="54" maxlength="128" name="actiongroupName" value="" id="actiongroupNameHeader"></TD></TR>
  <TR>
    <TD ALIGN="LEFT"><STRONG><Label for="displayNameHeader"><%= UIUtil.toHTML((String)policyNLS.get("displayNameHeader")) %></Lebel></STRONG> </TD></TR>
  <TR>
