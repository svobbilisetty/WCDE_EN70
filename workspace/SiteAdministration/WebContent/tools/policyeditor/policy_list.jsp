...
function changeOrg() {
  ...
  deSelectAll();
  var theURL2 = top.getWebappPath() +'NewDynamicListView?ActionXMLFile=policyeditor.policyList&amp;cmd=PolicyListView&amp;searchOrg=' + o + '&amp;orderby=' + getSortby();
...
<%= comm.addDlistColumnHeading((String) policyListNLS.get("displayNameHeader"), PolicyDescriptionTable.DISPLAYNAME, sortby.equals(PolicyDescriptionTable.DISPLAYNAME), "10", false) %>
<%= comm.addDlistColumnHeading((String)policyListNLS.get("policyDescriptionHeader"), PolicyDescriptionTable.DESCRIPTION, sortby.equals(PolicyDescriptionTable.DESCRIPTION), "10", false) %>
...
{
%>
  parent.generalForm.numberOfHits.value = "<%= numberOfHits %>";
<%
}
%>
