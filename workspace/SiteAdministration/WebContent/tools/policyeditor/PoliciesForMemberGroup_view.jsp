...
<%
   ...
   policiesForResourceGroupBean.setMemberGroupId(Long.valueOf(memberGroupId)) ;
...
{
  for (var i=0; i < document.PoliciesForMemberGroupViewForm.elements.length; i++) 
  {
     var e = document.PoliciesForMemberGroupViewForm.elements[i];
...
<%= comm.addControlPanel("policyeditor.PoliciesForMemberGroupView",totalpage,totalsize,locale) %>
<FORM NAME="PoliciesForMemberGroupViewForm" action="" method="GET">
...
<P>
<% 
     out.println(UIUtil.toHTML((String)PolicyUtilityNLS.get("emptyPoliciesForMemberGroupView"))); 
   }
%>
