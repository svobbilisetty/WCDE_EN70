...
<%
  ...
  String resourceId = (String) request.getParameter("resourceId");
   resourceGroupForResourceBean.setResourceId(Integer.valueOf(resourceId)) ;
...
{
  for (var i=0; i < document.ResourceGroupsForResourceViewForm.elements.length; i++) 
  {
     var e = document.ResourceGroupsForResourceViewForm.elements[i];
...
<%= comm.addControlPanel("policyeditor.ResourceGroupsForResourceView",totalpage,totalsize,locale) %>
<FORM NAME="ResourceGroupsForResourceViewForm" action="" method="GET">
...
<P>
<% 
     out.println(UIUtil.toHTML((String)PolicyUtilityNLS.get("emptyResourceGroupsForResourceView"))); 
   }
%>
