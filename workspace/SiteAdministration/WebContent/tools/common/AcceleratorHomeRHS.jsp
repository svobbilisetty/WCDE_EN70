		...
		<tbody>									
			...
			<tr>
				<td class="entry_text" valign="top" colspan="3">
					<%= resourceBundle.get("rhs_intro") %> <%= resourceBundle.get("helpText") %>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("rhs_sec1_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("rhs_sec1_list") %>
					</ul>
				</td>
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("rhs_sec2_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("rhs_sec2_list") %>
					</ul>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("rhs_sec3_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("rhs_sec3_list") %>
					</ul>
				</td>
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("rhs_sec4_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("rhs_sec4_list") %>
					</ul>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("rhs_sec5_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("rhs_sec5_list") %>
					</ul>
				</td>
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
					<%= resourceBundle.get("rhs_sec6_text") %>
					<ul class="entry_list">
						<%= resourceBundle.get("rhs_sec6_list") %>
					</ul>
				</td>
			</tr>
		</tbody>
