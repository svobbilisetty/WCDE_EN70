...
function openHelp() {
	...
	if (helpkey == null || helpkey == "") {
 	...
 	var hwin = window.open("http://<%= WcsApp.configProperties.getValue("Websphere/HelpServerHostName") %>" + help_base + help[helpkey], "Help", "width=700,height=450,toolbar=no,resizable=yes,scrollbars=yes,menubar=yes,copyhistory=no");
 	hwin.focus();
}
