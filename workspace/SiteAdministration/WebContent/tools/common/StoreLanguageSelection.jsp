...
function openHelp() {
	var helpfile= 'http://<%= WcsApp.configProperties.getValue("Websphere/HelpServerHostName") + ":" + WcsApp.configProperties.getValue("Websphere/HelpServerPort", "8001") %>/help/index.jsp?lang=<%=locale.toString()%>&topic=/com.ibm.commerce.base.doc/f1/fadstore.htm';
