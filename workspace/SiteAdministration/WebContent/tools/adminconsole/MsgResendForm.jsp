...
//  if ((profile_id != null) && (!profile_id.equals("")))  {
   ...
   out.println("MSG."+MessagingSystemConstants.MSG_VIEW_STORE_ID+"='"+store_id+"';");
   out.println("MSG."+MessagingSystemConstants.MSG_VIEW_TRANSPORT_ID+"='"+transport_id+"';");
   out.println("MSG."+MessagingSystemConstants.MSG_VIEW_MSG_ID+" = '"+msg_id+"';");
   out.println("MSG.mode = '" + request.getParameter("table") + "'");
