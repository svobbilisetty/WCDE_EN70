									...
									<tbody>
										...
										<tr>
											<td style="padding-left: 25px;">
												<button type="button" onclick="cancelStoreSelection('<%= selectStore %>');"><%=UIUtil.toHTML(okButtonStr)%></button>
											</td>
										</tr>										
									</tbody>
								</table>	
...
%> 
												<button type="button" onclick="cancelStoreSelection('<%= selectStore %>');"><%=UIUtil.toHTML(cancelButtonStr)%></button>
<% 
	} 
	else { 
%> 
												<button type="button" onclick="cancelStoreSelection('<%= selectStore %>', '<%= orig_strStoreId %>', '<%= orig_strLangId %>');"><%=UIUtil.toHTML(cancelButtonStr)%></button>
<% 
	} 
%> 												
