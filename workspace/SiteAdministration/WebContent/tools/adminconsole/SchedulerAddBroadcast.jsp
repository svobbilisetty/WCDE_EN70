...
<!---- //hide script from old browsers
    ...
    function validatePanelData() {
          ...
          // building the URL
          <%= (jobId != null && !jobId.equals("")) ? "var url = 'EditJob?URL=MsgMessagingSystemResponseView&ERR_COM=MsgMessagingSystemResponseView&jobId="+jobId+"';" : "var url = 'AddBroadcastJob?URL=MsgMessagingSystemResponseView&ERR_COM=MsgMessagingSystemResponseView';" %>
          var params = '';
          var pathInfo = '';
          var start = '';
...
<%     
     	out.println("<option value='" + pathInfo + "'>");
...
%></select>
     ...
     <TR><TD><INPUT NAME="queryString" VALUE="<%= queryString  %>" SIZE="40" id="S2"></TD></TR>
     <TR><TD><LABEL for="S4"><%= schedulerNLS.get("schedulerNameCaption") %></LABEL></TD></TR>
     <TR><TD><INPUT NAME="name" VALUE="<%= name %>" SIZE="40" id="S4"></TD></TR>
</TABLE>
