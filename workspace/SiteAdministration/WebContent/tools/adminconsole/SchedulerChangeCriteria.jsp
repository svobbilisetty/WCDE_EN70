...
<!-- // hide from older browsers
     ...
     function displayResults() {
        ...
        <% if ( ECConstants.EC_NO_STOREID.equals(store_id) ) { %>
        	var url = 'NewDynamicListView?ActionXMLFile=adminconsole.SchedulerMain&amp;cmd=SchedulerMainView&amp;listsize=<%=getListSize()%>&amp;startindex=0&amp;orderby=<%=orderByParm%>&amp;refnum=0'+criteria;
	<% } else { %>
		var url = 'NewDynamicListView?ActionXMLFile=adminconsole.StoreSchedulerMain&amp;cmd=StoreSchedulerMainView&amp;listsize=<%=getListSize()%>&amp;startindex=0&amp;orderby=<%=orderByParm%>&amp;refnum=0'+criteria;
	<% } %>        	
