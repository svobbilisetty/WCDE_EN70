...
<%
  ...
  out.println("function convertParametersToXML() {");
    ...
    if(nlList.getSpecSize()>0) {
      ...
      if ((profile_id != null) && (!profile_id.equals(""))) out.println("NLSEDITATT.profile_id='"+profile_id+"';");
    }
  ...
  if ((profile_id != null) && (!profile_id.equals("")))  {
   ...
   out.println("PROFILE."+MessagingSystemConstants.TC_PROFILE_STORE_ID+"='"+store_id+"';");
   out.println("PROFILE."+MessagingSystemConstants.TC_PROFILE_TRANSPORT_ID+"='"+transport_id+"';");
   out.println("PROFILE."+MessagingSystemConstants.TC_PROFILE_PROFILE_ID+"='"+profile_id+"';");
   ...
   out.println("PROFILE."+MessagingSystemConstants.TC_PROFILE_MSGTYPE_ID+" = '"+msgtype_id+"';");
