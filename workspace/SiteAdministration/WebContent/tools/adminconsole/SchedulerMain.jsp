...
%>
     ...
     function changeCriteria() {
         ...
         var url = top.getWebappPath() + "DialogView?ActionXMLFile=adminconsole.SchedulerMain&amp;XMLFile=adminconsole.SchedulerCriteria&amp;cmd=SchedulerMainView&amp;listsize=<%=listSize%>&amp;startindex=<%=startIndex%>&amp;orderby=<%=orderByParm%>&amp;startDateCriteria=<%=startTime%>&amp;endDateCriteria=<%=endTime%>&amp;refnum=0'";
         parent.location.replace(url);
