...
function getResultsSize() { 
     ...
     function refreshRegistry() {
          ...
          var url = top.getWebappPath() + "RefreshRegistry?registryName=" + checked[0] + "&URL=NewDynamicListView?ActionXMLFile=adminconsole.RegistryMain&amp;cmd=AdminRegistryListView&pagenumber=" + <%= pageNumber %> + "&component="+ checked[0];
          parent.location.replace(url);
     }

     function refreshRegistryBySelect(item) {
          var url = top.getWebappPath() + "RefreshRegistry?registryName=" + item + "&URL=NewDynamicListView?ActionXMLFile=adminconsole.RegistryMain&amp;cmd=AdminRegistryListView&pagenumber=" + <%= pageNumber %> + "&component="+item;
          parent.location.replace(url);
     }

     function refreshRegistryAll() {
          var url = top.getWebappPath() + "RefreshRegistry?URL=NewDynamicListView?ActionXMLFile=adminconsole.RegistryMain&amp;cmd=AdminRegistryListView&pagenumber=" + <%= pageNumber %> + "&component=ALL";
          parent.location.replace(url);
     }
