...
function validatePanelData() {
   ...
   parent.setCurrentPanelAttribute("<%=MessagingSystemConstants.TC_STORETRANS_STORE_ID%>", "<%=request.getParameter(MessagingSystemConstants.TC_STORETRANS_STORE_ID)%>");
   parent.setCurrentPanelAttribute("<%=MessagingSystemConstants.TC_PROFILE_PROFILE_ID%>", "<%=request.getParameter(MessagingSystemConstants.TC_PROFILE_PROFILE_ID)%>");
...
%>
    ...
    value="<%=(lowpriority !=null && lowpriority.length() != 0)? lowpriority : "0"%>"
    ...
    value="<%=(highpriority !=null && lowpriority.length() != 0)? highpriority : "0"%>"
